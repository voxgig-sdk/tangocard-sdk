...
Results: The created order; Orders.
...
- API server: `https://integration-api.tangocard.com/raas/v2`
...
- `tangocard_list`: List records for an entity. Supported entities: `catalog`, `customer`, `order`.
- `tangocard_load`: Load one record for an entity. No active entity supports this operation.
