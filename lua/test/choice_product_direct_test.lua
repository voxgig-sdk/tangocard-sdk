...
describe("ChoiceProductDirect", function()
  it("should direct-list-choice_product", function()
    local setup = choice_product_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-choice_product", setup.live and "live" or "unit")
  ...
  it("should direct-load-choice_product", function()
    local setup = choice_product_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-choice_product", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function choice_product_direct_setup(mockres)
