-- CredentialTypeView direct test
...
describe("CredentialTypeViewDirect", function()
  it("should direct-list-credential_type_view", function()
    local setup = credential_type_view_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-credential_type_view", setup.live and "live" or "unit")
...
function credential_type_view_direct_setup(mockres)
