...
describe("CreditCardDirect", function()
  it("should direct-load-credit_card", function()
    local setup = credit_card_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-credit_card", setup.live and "live" or "unit")
...
function credit_card_direct_setup(mockres)
