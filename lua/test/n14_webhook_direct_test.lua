...
describe("N14WebhookDirect", function()
  it("should direct-list-n14_webhook", function()
    local setup = n14_webhook_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-n14_webhook", setup.live and "live" or "unit")
  ...
  it("should direct-load-n14_webhook", function()
    local setup = n14_webhook_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-n14_webhook", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function n14_webhook_direct_setup(mockres)
