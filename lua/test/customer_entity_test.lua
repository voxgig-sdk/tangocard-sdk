...
describe("CustomerEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TANGOCARD_TEST_CUSTOMER_ENTID JSON to run live")
      return
    end
...
function customer_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TANGOCARD_TEST_CUSTOMER_ENTID")
