-- BrandCategoriesView direct test
...
describe("BrandCategoriesViewDirect", function()
  it("should direct-list-brand_categories_view", function()
    local setup = brand_categories_view_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-brand_categories_view", setup.live and "live" or "unit")
...
function brand_categories_view_direct_setup(mockres)
