-- PrepaidCardTransaction direct test
...
describe("PrepaidCardTransactionDirect", function()
  it("should direct-load-prepaid_card_transaction", function()
    local setup = prepaid_card_transaction_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-prepaid_card_transaction", setup.live and "live" or "unit")
...
function prepaid_card_transaction_direct_setup(mockres)
