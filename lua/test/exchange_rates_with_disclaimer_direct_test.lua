-- ExchangeRatesWithDisclaimer direct test
...
describe("ExchangeRatesWithDisclaimerDirect", function()
  it("should direct-list-exchange_rates_with_disclaimer", function()
    local setup = exchange_rates_with_disclaimer_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-exchange_rates_with_disclaimer", setup.live and "live" or "unit")
...
function exchange_rates_with_disclaimer_direct_setup(mockres)
