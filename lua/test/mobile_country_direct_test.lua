...
describe("MobileCountryDirect", function()
  it("should direct-load-mobile_country", function()
    local setup = mobile_country_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-mobile_country", setup.live and "live" or "unit")
...
function mobile_country_direct_setup(mockres)
