-- EmbeddableResponseDto direct test
...
describe("EmbeddableResponseDtoDirect", function()
  it("should direct-load-embeddable_response_dto", function()
    local setup = embeddable_response_dto_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-embeddable_response_dto", setup.live and "live" or "unit")
...
function embeddable_response_dto_direct_setup(mockres)
