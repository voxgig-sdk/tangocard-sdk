...
describe("RewardReasonsMapDirect", function()
  it("should direct-load-reward_reasons_map", function()
    local setup = reward_reasons_map_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-reward_reasons_map", setup.live and "live" or "unit")
...
function reward_reasons_map_direct_setup(mockres)
