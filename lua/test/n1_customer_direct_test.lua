...
describe("N1CustomerDirect", function()
  it("should direct-load-n1_customer", function()
    local setup = n1_customer_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-n1_customer", setup.live and "live" or "unit")
...
function n1_customer_direct_setup(mockres)
