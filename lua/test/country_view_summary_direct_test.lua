-- CountryViewSummary direct test
...
describe("CountryViewSummaryDirect", function()
  it("should direct-load-country_view_summary", function()
    local setup = country_view_summary_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-country_view_summary", setup.live and "live" or "unit")
...
function country_view_summary_direct_setup(mockres)
