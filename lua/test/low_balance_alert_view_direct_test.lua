-- LowBalanceAlertView direct test
...
describe("LowBalanceAlertViewDirect", function()
  it("should direct-load-low_balance_alert_view", function()
    local setup = low_balance_alert_view_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-low_balance_alert_view", setup.live and "live" or "unit")
...
function low_balance_alert_view_direct_setup(mockres)
