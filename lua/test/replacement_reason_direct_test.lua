...
describe("ReplacementReasonDirect", function()
  it("should direct-list-replacement_reason", function()
    local setup = replacement_reason_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-replacement_reason", setup.live and "live" or "unit")
...
function replacement_reason_direct_setup(mockres)
