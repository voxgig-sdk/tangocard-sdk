-- AsyncReasonCodesView direct test
...
describe("AsyncReasonCodesViewDirect", function()
  it("should direct-load-async_reason_codes_view", function()
    local setup = async_reason_codes_view_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-async_reason_codes_view", setup.live and "live" or "unit")
...
function async_reason_codes_view_direct_setup(mockres)
