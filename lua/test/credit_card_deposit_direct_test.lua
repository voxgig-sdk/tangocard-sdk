...
describe("CreditCardDepositDirect", function()
  it("should direct-load-credit_card_deposit", function()
    local setup = credit_card_deposit_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-credit_card_deposit", setup.live and "live" or "unit")
...
function credit_card_deposit_direct_setup(mockres)
