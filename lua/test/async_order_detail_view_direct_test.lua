-- AsyncOrderDetailView direct test
...
describe("AsyncOrderDetailViewDirect", function()
  it("should direct-load-async_order_detail_view", function()
    local setup = async_order_detail_view_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-async_order_detail_view", setup.live and "live" or "unit")
...
function async_order_detail_view_direct_setup(mockres)
