-- EmailTemplateViewVerbose direct test
...
describe("EmailTemplateViewVerboseDirect", function()
  it("should direct-list-email_template_view_verbose", function()
    local setup = email_template_view_verbose_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-email_template_view_verbose", setup.live and "live" or "unit")
  ...
  it("should direct-load-email_template_view_verbose", function()
    local setup = email_template_view_verbose_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-email_template_view_verbose", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function email_template_view_verbose_direct_setup(mockres)
