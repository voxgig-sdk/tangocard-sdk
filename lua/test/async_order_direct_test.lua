...
describe("AsyncOrderDirect", function()
  it("should direct-list-async_order", function()
    local setup = async_order_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-async_order", setup.live and "live" or "unit")
...
function async_order_direct_setup(mockres)
