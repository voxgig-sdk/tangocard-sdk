...
local N9DigitalTemplateEntity = {}
N9DigitalTemplateEntity.__index = N9DigitalTemplateEntity


function N9DigitalTemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, N9DigitalTemplateEntity)
  self._name = "n9_digital_template"
  self._client = client
...
function N9DigitalTemplateEntity:get_name()
  return self._name
end


function N9DigitalTemplateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return N9DigitalTemplateEntity.new(self._client, opts)
end
...
function N9DigitalTemplateEntity:mark_deleted()
  self._deleted = true
end


function N9DigitalTemplateEntity:deleted()
  return true == self._deleted
end


function N9DigitalTemplateEntity:data_set(args)
  if args ~= nil then
...
function N9DigitalTemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function N9DigitalTemplateEntity:match_set(args)
  if args ~= nil then
...
function N9DigitalTemplateEntity:match_get()
...
function N9DigitalTemplateEntity:stream(action, args, callopts)
...
---@param reqmatch N9DigitalTemplateRemoveMatch
---@param ctrl? table
---@return N9DigitalTemplate
---@return string? err
function N9DigitalTemplateEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function N9DigitalTemplateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return N9DigitalTemplateEntity
