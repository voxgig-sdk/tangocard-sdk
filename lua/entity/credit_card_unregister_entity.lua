...
local CreditCardUnregisterEntity = {}
CreditCardUnregisterEntity.__index = CreditCardUnregisterEntity


function CreditCardUnregisterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreditCardUnregisterEntity)
  self._name = "credit_card_unregister"
  self._client = client
...
function CreditCardUnregisterEntity:get_name()
  return self._name
end


function CreditCardUnregisterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreditCardUnregisterEntity.new(self._client, opts)
end
...
function CreditCardUnregisterEntity:mark_deleted()
  self._deleted = true
end


function CreditCardUnregisterEntity:deleted()
  return true == self._deleted
end


function CreditCardUnregisterEntity:data_set(args)
  if args ~= nil then
...
function CreditCardUnregisterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreditCardUnregisterEntity:match_set(args)
  if args ~= nil then
...
function CreditCardUnregisterEntity:match_get()
...
function CreditCardUnregisterEntity:stream(action, args, callopts)
...
---@param reqdata CreditCardUnregisterCreateData
---@param ctrl? table
---@return CreditCardUnregister
---@return string? err
function CreditCardUnregisterEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CreditCardUnregisterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CreditCardUnregisterEntity
