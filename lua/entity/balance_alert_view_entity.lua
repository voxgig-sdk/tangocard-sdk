...
local BalanceAlertViewEntity = {}
BalanceAlertViewEntity.__index = BalanceAlertViewEntity


function BalanceAlertViewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BalanceAlertViewEntity)
  self._name = "balance_alert_view"
  self._client = client
...
function BalanceAlertViewEntity:get_name()
  return self._name
end


function BalanceAlertViewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BalanceAlertViewEntity.new(self._client, opts)
end
...
function BalanceAlertViewEntity:mark_deleted()
  self._deleted = true
end


function BalanceAlertViewEntity:deleted()
  return true == self._deleted
end


function BalanceAlertViewEntity:data_set(args)
  if args ~= nil then
...
function BalanceAlertViewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BalanceAlertViewEntity:match_set(args)
  if args ~= nil then
...
function BalanceAlertViewEntity:match_get()
...
function BalanceAlertViewEntity:stream(action, args, callopts)
...
---@param reqmatch BalanceAlertViewRemoveMatch
---@param ctrl? table
---@return BalanceAlertView
---@return string? err
function BalanceAlertViewEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function BalanceAlertViewEntity:_run_op(ctx, post_done)
  local utility = self._utility
