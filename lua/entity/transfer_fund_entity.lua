...
local TransferFundEntity = {}
TransferFundEntity.__index = TransferFundEntity


function TransferFundEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransferFundEntity)
  self._name = "transfer_fund"
  self._client = client
...
function TransferFundEntity:get_name()
  return self._name
end


function TransferFundEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TransferFundEntity.new(self._client, opts)
end
...
function TransferFundEntity:mark_deleted()
  self._deleted = true
end


function TransferFundEntity:deleted()
  return true == self._deleted
end


function TransferFundEntity:data_set(args)
  if args ~= nil then
...
function TransferFundEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransferFundEntity:match_set(args)
  if args ~= nil then
...
function TransferFundEntity:match_get()
...
function TransferFundEntity:stream(action, args, callopts)
...
---@param reqdata TransferFundCreateData
---@param ctrl? table
---@return TransferFund
---@return string? err
function TransferFundEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TransferFundEntity:_run_op(ctx, post_done)
  local utility = self._utility
