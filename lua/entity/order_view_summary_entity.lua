...
local OrderViewSummaryEntity = {}
OrderViewSummaryEntity.__index = OrderViewSummaryEntity


function OrderViewSummaryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrderViewSummaryEntity)
  self._name = "order_view_summary"
  self._client = client
...
function OrderViewSummaryEntity:get_name()
  return self._name
end


function OrderViewSummaryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrderViewSummaryEntity.new(self._client, opts)
end
...
function OrderViewSummaryEntity:mark_deleted()
  self._deleted = true
end


function OrderViewSummaryEntity:deleted()
  return true == self._deleted
end


function OrderViewSummaryEntity:data_set(args)
  if args ~= nil then
...
function OrderViewSummaryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrderViewSummaryEntity:match_set(args)
  if args ~= nil then
...
function OrderViewSummaryEntity:match_get()
...
function OrderViewSummaryEntity:stream(action, args, callopts)
...
---@param reqdata OrderViewSummaryCreateData
---@param ctrl? table
---@return OrderViewSummary
---@return string? err
function OrderViewSummaryEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function OrderViewSummaryEntity:_run_op(ctx, post_done)
  local utility = self._utility
