...
local AllEventTypeEntity = {}
AllEventTypeEntity.__index = AllEventTypeEntity


function AllEventTypeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AllEventTypeEntity)
  self._name = "all_event_type"
  self._client = client
...
function AllEventTypeEntity:get_name()
  return self._name
end


function AllEventTypeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AllEventTypeEntity.new(self._client, opts)
end
...
function AllEventTypeEntity:mark_deleted()
  self._deleted = true
end


function AllEventTypeEntity:deleted()
  return true == self._deleted
end


function AllEventTypeEntity:data_set(args)
  if args ~= nil then
...
function AllEventTypeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AllEventTypeEntity:match_set(args)
  if args ~= nil then
...
function AllEventTypeEntity:match_get()
...
function AllEventTypeEntity:stream(action, args, callopts)
...
---@param reqmatch AllEventTypeListMatch
---@param ctrl? table
---@return AllEventType[]
---@return string? err
function AllEventTypeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AllEventTypeEntity:_run_op(ctx, post_done)
  local utility = self._utility
