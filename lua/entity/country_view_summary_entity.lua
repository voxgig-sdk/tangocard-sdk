...
local CountryViewSummaryEntity = {}
CountryViewSummaryEntity.__index = CountryViewSummaryEntity


function CountryViewSummaryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CountryViewSummaryEntity)
  self._name = "country_view_summary"
  self._client = client
...
function CountryViewSummaryEntity:get_name()
  return self._name
end


function CountryViewSummaryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CountryViewSummaryEntity.new(self._client, opts)
end
...
function CountryViewSummaryEntity:mark_deleted()
  self._deleted = true
end


function CountryViewSummaryEntity:deleted()
  return true == self._deleted
end


function CountryViewSummaryEntity:data_set(args)
  if args ~= nil then
...
function CountryViewSummaryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CountryViewSummaryEntity:match_set(args)
  if args ~= nil then
...
function CountryViewSummaryEntity:match_get()
...
function CountryViewSummaryEntity:stream(action, args, callopts)
...
---@param reqmatch CountryViewSummaryLoadMatch
---@param ctrl? table
---@return CountryViewSummary
---@return string? err
function CountryViewSummaryEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CountryViewSummaryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CountryViewSummaryEntity
