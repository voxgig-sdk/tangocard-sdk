-- Tangocard SDK LowBalanceAlertListView entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local LowBalanceAlertListViewEntity = {}
LowBalanceAlertListViewEntity.__index = LowBalanceAlertListViewEntity


function LowBalanceAlertListViewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LowBalanceAlertListViewEntity)
  self._name = "low_balance_alert_list_view"
  self._client = client
...
function LowBalanceAlertListViewEntity:get_name()
  return self._name
end


function LowBalanceAlertListViewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LowBalanceAlertListViewEntity.new(self._client, opts)
end
...
function LowBalanceAlertListViewEntity:mark_deleted()
  self._deleted = true
end


function LowBalanceAlertListViewEntity:deleted()
  return true == self._deleted
end


function LowBalanceAlertListViewEntity:data_set(args)
  if args ~= nil then
...
function LowBalanceAlertListViewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LowBalanceAlertListViewEntity:match_set(args)
  if args ~= nil then
...
function LowBalanceAlertListViewEntity:match_get()
...
function LowBalanceAlertListViewEntity:stream(action, args, callopts)
...
---@param reqmatch LowBalanceAlertListViewListMatch
---@param ctrl? table
---@return LowBalanceAlertListView[]
---@return string? err
function LowBalanceAlertListViewEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function LowBalanceAlertListViewEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return LowBalanceAlertListViewEntity
