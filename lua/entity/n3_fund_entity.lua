-- Tangocard SDK N3Fund entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local N3FundEntity = {}
N3FundEntity.__index = N3FundEntity


function N3FundEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, N3FundEntity)
  self._name = "n3_fund"
  self._client = client
...
function N3FundEntity:get_name()
  return self._name
end


function N3FundEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return N3FundEntity.new(self._client, opts)
end
...
function N3FundEntity:mark_deleted()
  self._deleted = true
end


function N3FundEntity:deleted()
  return true == self._deleted
end


function N3FundEntity:data_set(args)
  if args ~= nil then
...
function N3FundEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function N3FundEntity:match_set(args)
  if args ~= nil then
...
function N3FundEntity:match_get()
...
function N3FundEntity:stream(action, args, callopts)
...
function N3FundEntity:_run_op(ctx, post_done)
  local utility = self._utility
