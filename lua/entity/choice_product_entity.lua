...
local ChoiceProductEntity = {}
ChoiceProductEntity.__index = ChoiceProductEntity


function ChoiceProductEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ChoiceProductEntity)
  self._name = "choice_product"
  self._client = client
...
function ChoiceProductEntity:get_name()
  return self._name
end


function ChoiceProductEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ChoiceProductEntity.new(self._client, opts)
end
...
function ChoiceProductEntity:mark_deleted()
  self._deleted = true
end


function ChoiceProductEntity:deleted()
  return true == self._deleted
end


function ChoiceProductEntity:data_set(args)
  if args ~= nil then
...
function ChoiceProductEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ChoiceProductEntity:match_set(args)
  if args ~= nil then
...
function ChoiceProductEntity:match_get()
...
function ChoiceProductEntity:stream(action, args, callopts)
...
---@param reqmatch ChoiceProductLoadMatch
---@param ctrl? table
---@return ChoiceProduct
---@return string? err
function ChoiceProductEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ChoiceProductListMatch
---@param ctrl? table
---@return ChoiceProduct[]
---@return string? err
function ChoiceProductEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ChoiceProductEntity:_run_op(ctx, post_done)
  local utility = self._utility
