-- Tangocard SDK UpdateWebhookSubscriptionResponseView entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UpdateWebhookSubscriptionResponseViewEntity = {}
UpdateWebhookSubscriptionResponseViewEntity.__index = UpdateWebhookSubscriptionResponseViewEntity


function UpdateWebhookSubscriptionResponseViewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UpdateWebhookSubscriptionResponseViewEntity)
  self._name = "update_webhook_subscription_response_view"
  self._client = client
...
function UpdateWebhookSubscriptionResponseViewEntity:get_name()
  return self._name
end


function UpdateWebhookSubscriptionResponseViewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UpdateWebhookSubscriptionResponseViewEntity.new(self._client, opts)
end
...
function UpdateWebhookSubscriptionResponseViewEntity:mark_deleted()
  self._deleted = true
end


function UpdateWebhookSubscriptionResponseViewEntity:deleted()
  return true == self._deleted
end


function UpdateWebhookSubscriptionResponseViewEntity:data_set(args)
  if args ~= nil then
...
function UpdateWebhookSubscriptionResponseViewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UpdateWebhookSubscriptionResponseViewEntity:match_set(args)
  if args ~= nil then
...
function UpdateWebhookSubscriptionResponseViewEntity:match_get()
...
function UpdateWebhookSubscriptionResponseViewEntity:stream(action, args, callopts)
...
---@param reqdata UpdateWebhookSubscriptionResponseViewUpdateData
---@param ctrl? table
---@return UpdateWebhookSubscriptionResponseView
---@return string? err
function UpdateWebhookSubscriptionResponseViewEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function UpdateWebhookSubscriptionResponseViewEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UpdateWebhookSubscriptionResponseViewEntity
