...
local LowBalanceAlertViewEntity = {}
LowBalanceAlertViewEntity.__index = LowBalanceAlertViewEntity


function LowBalanceAlertViewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LowBalanceAlertViewEntity)
  self._name = "low_balance_alert_view"
  self._client = client
...
function LowBalanceAlertViewEntity:get_name()
  return self._name
end


function LowBalanceAlertViewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LowBalanceAlertViewEntity.new(self._client, opts)
end
...
function LowBalanceAlertViewEntity:mark_deleted()
  self._deleted = true
end


function LowBalanceAlertViewEntity:deleted()
  return true == self._deleted
end


function LowBalanceAlertViewEntity:data_set(args)
  if args ~= nil then
...
function LowBalanceAlertViewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LowBalanceAlertViewEntity:match_set(args)
  if args ~= nil then
...
function LowBalanceAlertViewEntity:match_get()
...
function LowBalanceAlertViewEntity:stream(action, args, callopts)
...
---@param reqmatch LowBalanceAlertViewLoadMatch
---@param ctrl? table
---@return LowBalanceAlertView
---@return string? err
function LowBalanceAlertViewEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata LowBalanceAlertViewCreateData
---@param ctrl? table
---@return LowBalanceAlertView
---@return string? err
function LowBalanceAlertViewEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata LowBalanceAlertViewUpdateData
---@param ctrl? table
---@return LowBalanceAlertView
---@return string? err
function LowBalanceAlertViewEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function LowBalanceAlertViewEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return LowBalanceAlertViewEntity
