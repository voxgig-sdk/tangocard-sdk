...
local BrandCategoriesViewEntity = {}
BrandCategoriesViewEntity.__index = BrandCategoriesViewEntity


function BrandCategoriesViewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BrandCategoriesViewEntity)
  self._name = "brand_categories_view"
  self._client = client
...
function BrandCategoriesViewEntity:get_name()
  return self._name
end


function BrandCategoriesViewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BrandCategoriesViewEntity.new(self._client, opts)
end
...
function BrandCategoriesViewEntity:mark_deleted()
  self._deleted = true
end


function BrandCategoriesViewEntity:deleted()
  return true == self._deleted
end


function BrandCategoriesViewEntity:data_set(args)
  if args ~= nil then
...
function BrandCategoriesViewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BrandCategoriesViewEntity:match_set(args)
  if args ~= nil then
...
function BrandCategoriesViewEntity:match_get()
...
function BrandCategoriesViewEntity:stream(action, args, callopts)
...
---@param reqmatch BrandCategoriesViewListMatch
---@param ctrl? table
---@return BrandCategoriesView[]
---@return string? err
function BrandCategoriesViewEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function BrandCategoriesViewEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return BrandCategoriesViewEntity
