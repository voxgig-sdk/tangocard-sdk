...
local AsyncReasonCodesViewEntity = {}
AsyncReasonCodesViewEntity.__index = AsyncReasonCodesViewEntity


function AsyncReasonCodesViewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AsyncReasonCodesViewEntity)
  self._name = "async_reason_codes_view"
  self._client = client
...
function AsyncReasonCodesViewEntity:get_name()
  return self._name
end


function AsyncReasonCodesViewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AsyncReasonCodesViewEntity.new(self._client, opts)
end
...
function AsyncReasonCodesViewEntity:mark_deleted()
  self._deleted = true
end


function AsyncReasonCodesViewEntity:deleted()
  return true == self._deleted
end


function AsyncReasonCodesViewEntity:data_set(args)
  if args ~= nil then
...
function AsyncReasonCodesViewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AsyncReasonCodesViewEntity:match_set(args)
  if args ~= nil then
...
function AsyncReasonCodesViewEntity:match_get()
...
function AsyncReasonCodesViewEntity:stream(action, args, callopts)
...
---@param reqmatch AsyncReasonCodesViewLoadMatch
---@param ctrl? table
---@return AsyncReasonCodesView
---@return string? err
function AsyncReasonCodesViewEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AsyncReasonCodesViewEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AsyncReasonCodesViewEntity
