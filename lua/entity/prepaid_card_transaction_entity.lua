...
local PrepaidCardTransactionEntity = {}
PrepaidCardTransactionEntity.__index = PrepaidCardTransactionEntity


function PrepaidCardTransactionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PrepaidCardTransactionEntity)
  self._name = "prepaid_card_transaction"
  self._client = client
...
function PrepaidCardTransactionEntity:get_name()
  return self._name
end


function PrepaidCardTransactionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PrepaidCardTransactionEntity.new(self._client, opts)
end
...
function PrepaidCardTransactionEntity:mark_deleted()
  self._deleted = true
end


function PrepaidCardTransactionEntity:deleted()
  return true == self._deleted
end


function PrepaidCardTransactionEntity:data_set(args)
  if args ~= nil then
...
function PrepaidCardTransactionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PrepaidCardTransactionEntity:match_set(args)
  if args ~= nil then
...
function PrepaidCardTransactionEntity:match_get()
...
function PrepaidCardTransactionEntity:stream(action, args, callopts)
...
---@param reqmatch PrepaidCardTransactionLoadMatch
---@param ctrl? table
---@return PrepaidCardTransaction
---@return string? err
function PrepaidCardTransactionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function PrepaidCardTransactionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PrepaidCardTransactionEntity
