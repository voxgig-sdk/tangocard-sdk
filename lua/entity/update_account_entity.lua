...
local UpdateAccountEntity = {}
UpdateAccountEntity.__index = UpdateAccountEntity


function UpdateAccountEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UpdateAccountEntity)
  self._name = "update_account"
  self._client = client
...
function UpdateAccountEntity:get_name()
  return self._name
end


function UpdateAccountEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UpdateAccountEntity.new(self._client, opts)
end
...
function UpdateAccountEntity:mark_deleted()
  self._deleted = true
end


function UpdateAccountEntity:deleted()
  return true == self._deleted
end


function UpdateAccountEntity:data_set(args)
  if args ~= nil then
...
function UpdateAccountEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UpdateAccountEntity:match_set(args)
  if args ~= nil then
...
function UpdateAccountEntity:match_get()
...
function UpdateAccountEntity:stream(action, args, callopts)
...
---@param reqdata UpdateAccountCreateData
---@param ctrl? table
---@return UpdateAccount
---@return string? err
function UpdateAccountEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function UpdateAccountEntity:_run_op(ctx, post_done)
  local utility = self._utility
