...
local ExchangeRatesWithDisclaimerEntity = {}
ExchangeRatesWithDisclaimerEntity.__index = ExchangeRatesWithDisclaimerEntity


function ExchangeRatesWithDisclaimerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ExchangeRatesWithDisclaimerEntity)
  self._name = "exchange_rates_with_disclaimer"
  self._client = client
...
function ExchangeRatesWithDisclaimerEntity:get_name()
  return self._name
end


function ExchangeRatesWithDisclaimerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ExchangeRatesWithDisclaimerEntity.new(self._client, opts)
end
...
function ExchangeRatesWithDisclaimerEntity:mark_deleted()
  self._deleted = true
end


function ExchangeRatesWithDisclaimerEntity:deleted()
  return true == self._deleted
end


function ExchangeRatesWithDisclaimerEntity:data_set(args)
  if args ~= nil then
...
function ExchangeRatesWithDisclaimerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ExchangeRatesWithDisclaimerEntity:match_set(args)
  if args ~= nil then
...
function ExchangeRatesWithDisclaimerEntity:match_get()
...
function ExchangeRatesWithDisclaimerEntity:stream(action, args, callopts)
...
---@param reqmatch ExchangeRatesWithDisclaimerListMatch
---@param ctrl? table
---@return ExchangeRatesWithDisclaimer[]
---@return string? err
function ExchangeRatesWithDisclaimerEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ExchangeRatesWithDisclaimerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ExchangeRatesWithDisclaimerEntity
