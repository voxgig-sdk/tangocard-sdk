...
local N14WebhookEntity = {}
N14WebhookEntity.__index = N14WebhookEntity


function N14WebhookEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, N14WebhookEntity)
  self._name = "n14_webhook"
  self._client = client
...
function N14WebhookEntity:get_name()
  return self._name
end


function N14WebhookEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return N14WebhookEntity.new(self._client, opts)
end
...
function N14WebhookEntity:mark_deleted()
  self._deleted = true
end


function N14WebhookEntity:deleted()
  return true == self._deleted
end


function N14WebhookEntity:data_set(args)
  if args ~= nil then
...
function N14WebhookEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function N14WebhookEntity:match_set(args)
  if args ~= nil then
...
function N14WebhookEntity:match_get()
...
function N14WebhookEntity:stream(action, args, callopts)
...
---@param reqmatch N14WebhookLoadMatch
---@param ctrl? table
---@return N14Webhook
---@return string? err
function N14WebhookEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch N14WebhookListMatch
---@param ctrl? table
---@return N14Webhook[]
---@return string? err
function N14WebhookEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata N14WebhookCreateData
---@param ctrl? table
---@return N14Webhook
---@return string? err
function N14WebhookEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch N14WebhookRemoveMatch
---@param ctrl? table
---@return N14Webhook
---@return string? err
function N14WebhookEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function N14WebhookEntity:_run_op(ctx, post_done)
  local utility = self._utility
