...
local ReplacementReasonEntity = {}
ReplacementReasonEntity.__index = ReplacementReasonEntity


function ReplacementReasonEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReplacementReasonEntity)
  self._name = "replacement_reason"
  self._client = client
...
function ReplacementReasonEntity:get_name()
  return self._name
end


function ReplacementReasonEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ReplacementReasonEntity.new(self._client, opts)
end
...
function ReplacementReasonEntity:mark_deleted()
  self._deleted = true
end


function ReplacementReasonEntity:deleted()
  return true == self._deleted
end


function ReplacementReasonEntity:data_set(args)
  if args ~= nil then
...
function ReplacementReasonEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReplacementReasonEntity:match_set(args)
  if args ~= nil then
...
function ReplacementReasonEntity:match_get()
...
function ReplacementReasonEntity:stream(action, args, callopts)
...
---@param reqmatch ReplacementReasonListMatch
---@param ctrl? table
---@return ReplacementReason[]
---@return string? err
function ReplacementReasonEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ReplacementReasonEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ReplacementReasonEntity
