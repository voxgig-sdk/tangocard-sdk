...
local CreditCardDepositEntity = {}
CreditCardDepositEntity.__index = CreditCardDepositEntity


function CreditCardDepositEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreditCardDepositEntity)
  self._name = "credit_card_deposit"
  self._client = client
...
function CreditCardDepositEntity:get_name()
  return self._name
end


function CreditCardDepositEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreditCardDepositEntity.new(self._client, opts)
end
...
function CreditCardDepositEntity:mark_deleted()
  self._deleted = true
end


function CreditCardDepositEntity:deleted()
  return true == self._deleted
end


function CreditCardDepositEntity:data_set(args)
  if args ~= nil then
...
function CreditCardDepositEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreditCardDepositEntity:match_set(args)
  if args ~= nil then
...
function CreditCardDepositEntity:match_get()
...
function CreditCardDepositEntity:stream(action, args, callopts)
...
---@param reqmatch CreditCardDepositLoadMatch
---@param ctrl? table
---@return CreditCardDeposit
---@return string? err
function CreditCardDepositEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata CreditCardDepositCreateData
---@param ctrl? table
---@return CreditCardDeposit
---@return string? err
function CreditCardDepositEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function CreditCardDepositEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CreditCardDepositEntity
