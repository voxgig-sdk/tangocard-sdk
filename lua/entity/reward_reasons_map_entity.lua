...
local RewardReasonsMapEntity = {}
RewardReasonsMapEntity.__index = RewardReasonsMapEntity


function RewardReasonsMapEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RewardReasonsMapEntity)
  self._name = "reward_reasons_map"
  self._client = client
...
function RewardReasonsMapEntity:get_name()
  return self._name
end


function RewardReasonsMapEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RewardReasonsMapEntity.new(self._client, opts)
end
...
function RewardReasonsMapEntity:mark_deleted()
  self._deleted = true
end


function RewardReasonsMapEntity:deleted()
  return true == self._deleted
end


function RewardReasonsMapEntity:data_set(args)
  if args ~= nil then
...
function RewardReasonsMapEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RewardReasonsMapEntity:match_set(args)
  if args ~= nil then
...
function RewardReasonsMapEntity:match_get()
...
function RewardReasonsMapEntity:stream(action, args, callopts)
...
---@param reqmatch RewardReasonsMapLoadMatch
---@param ctrl? table
---@return RewardReasonsMap
---@return string? err
function RewardReasonsMapEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RewardReasonsMapEntity:_run_op(ctx, post_done)
  local utility = self._utility
