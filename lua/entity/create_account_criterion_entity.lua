-- Tangocard SDK CreateAccountCriterion entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CreateAccountCriterionEntity = {}
CreateAccountCriterionEntity.__index = CreateAccountCriterionEntity


function CreateAccountCriterionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreateAccountCriterionEntity)
  self._name = "create_account_criterion"
  self._client = client
...
function CreateAccountCriterionEntity:get_name()
  return self._name
end


function CreateAccountCriterionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreateAccountCriterionEntity.new(self._client, opts)
end
...
function CreateAccountCriterionEntity:mark_deleted()
  self._deleted = true
end


function CreateAccountCriterionEntity:deleted()
  return true == self._deleted
end


function CreateAccountCriterionEntity:data_set(args)
  if args ~= nil then
...
function CreateAccountCriterionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreateAccountCriterionEntity:match_set(args)
  if args ~= nil then
...
function CreateAccountCriterionEntity:match_get()
...
function CreateAccountCriterionEntity:stream(action, args, callopts)
...
---@param reqdata CreateAccountCriterionCreateData
---@param ctrl? table
---@return CreateAccountCriterion
---@return string? err
function CreateAccountCriterionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CreateAccountCriterionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CreateAccountCriterionEntity
