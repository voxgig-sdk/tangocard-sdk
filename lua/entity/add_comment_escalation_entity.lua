...
local AddCommentEscalationEntity = {}
AddCommentEscalationEntity.__index = AddCommentEscalationEntity


function AddCommentEscalationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AddCommentEscalationEntity)
  self._name = "add_comment_escalation"
  self._client = client
...
function AddCommentEscalationEntity:get_name()
  return self._name
end


function AddCommentEscalationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AddCommentEscalationEntity.new(self._client, opts)
end
...
function AddCommentEscalationEntity:mark_deleted()
  self._deleted = true
end


function AddCommentEscalationEntity:deleted()
  return true == self._deleted
end


function AddCommentEscalationEntity:data_set(args)
  if args ~= nil then
...
function AddCommentEscalationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AddCommentEscalationEntity:match_set(args)
  if args ~= nil then
...
function AddCommentEscalationEntity:match_get()
...
function AddCommentEscalationEntity:stream(action, args, callopts)
...
---@param reqdata AddCommentEscalationCreateData
---@param ctrl? table
---@return AddCommentEscalation
---@return string? err
function AddCommentEscalationEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function AddCommentEscalationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AddCommentEscalationEntity
