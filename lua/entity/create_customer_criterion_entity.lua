-- Tangocard SDK CreateCustomerCriterion entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CreateCustomerCriterionEntity = {}
CreateCustomerCriterionEntity.__index = CreateCustomerCriterionEntity


function CreateCustomerCriterionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreateCustomerCriterionEntity)
  self._name = "create_customer_criterion"
  self._client = client
...
function CreateCustomerCriterionEntity:get_name()
  return self._name
end


function CreateCustomerCriterionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreateCustomerCriterionEntity.new(self._client, opts)
end
...
function CreateCustomerCriterionEntity:mark_deleted()
  self._deleted = true
end


function CreateCustomerCriterionEntity:deleted()
  return true == self._deleted
end


function CreateCustomerCriterionEntity:data_set(args)
  if args ~= nil then
...
function CreateCustomerCriterionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreateCustomerCriterionEntity:match_set(args)
  if args ~= nil then
...
function CreateCustomerCriterionEntity:match_get()
...
function CreateCustomerCriterionEntity:stream(action, args, callopts)
...
function CreateCustomerCriterionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CreateCustomerCriterionEntity
