...
local EmbeddableResponseDtoEntity = {}
EmbeddableResponseDtoEntity.__index = EmbeddableResponseDtoEntity


function EmbeddableResponseDtoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmbeddableResponseDtoEntity)
  self._name = "embeddable_response_dto"
  self._client = client
...
function EmbeddableResponseDtoEntity:get_name()
  return self._name
end


function EmbeddableResponseDtoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmbeddableResponseDtoEntity.new(self._client, opts)
end
...
function EmbeddableResponseDtoEntity:mark_deleted()
  self._deleted = true
end


function EmbeddableResponseDtoEntity:deleted()
  return true == self._deleted
end


function EmbeddableResponseDtoEntity:data_set(args)
  if args ~= nil then
...
function EmbeddableResponseDtoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmbeddableResponseDtoEntity:match_set(args)
  if args ~= nil then
...
function EmbeddableResponseDtoEntity:match_get()
...
function EmbeddableResponseDtoEntity:stream(action, args, callopts)
...
---@param reqmatch EmbeddableResponseDtoLoadMatch
---@param ctrl? table
---@return EmbeddableResponseDto
---@return string? err
function EmbeddableResponseDtoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EmbeddableResponseDtoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmbeddableResponseDtoEntity
