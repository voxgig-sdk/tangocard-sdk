...
local EmailTemplateViewVerboseEntity = {}
EmailTemplateViewVerboseEntity.__index = EmailTemplateViewVerboseEntity


function EmailTemplateViewVerboseEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmailTemplateViewVerboseEntity)
  self._name = "email_template_view_verbose"
  self._client = client
...
function EmailTemplateViewVerboseEntity:get_name()
  return self._name
end


function EmailTemplateViewVerboseEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmailTemplateViewVerboseEntity.new(self._client, opts)
end
...
function EmailTemplateViewVerboseEntity:mark_deleted()
  self._deleted = true
end


function EmailTemplateViewVerboseEntity:deleted()
  return true == self._deleted
end


function EmailTemplateViewVerboseEntity:data_set(args)
  if args ~= nil then
...
function EmailTemplateViewVerboseEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmailTemplateViewVerboseEntity:match_set(args)
  if args ~= nil then
...
function EmailTemplateViewVerboseEntity:match_get()
...
function EmailTemplateViewVerboseEntity:stream(action, args, callopts)
...
---@param reqmatch EmailTemplateViewVerboseLoadMatch
---@param ctrl? table
---@return EmailTemplateViewVerbose
---@return string? err
function EmailTemplateViewVerboseEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch EmailTemplateViewVerboseListMatch
---@param ctrl? table
---@return EmailTemplateViewVerbose[]
---@return string? err
function EmailTemplateViewVerboseEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata EmailTemplateViewVerboseCreateData
---@param ctrl? table
---@return EmailTemplateViewVerbose
---@return string? err
function EmailTemplateViewVerboseEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata EmailTemplateViewVerboseUpdateData
---@param ctrl? table
---@return EmailTemplateViewVerbose
---@return string? err
function EmailTemplateViewVerboseEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function EmailTemplateViewVerboseEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmailTemplateViewVerboseEntity
