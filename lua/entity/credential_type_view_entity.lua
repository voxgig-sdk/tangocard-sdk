...
local CredentialTypeViewEntity = {}
CredentialTypeViewEntity.__index = CredentialTypeViewEntity


function CredentialTypeViewEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CredentialTypeViewEntity)
  self._name = "credential_type_view"
  self._client = client
...
function CredentialTypeViewEntity:get_name()
  return self._name
end


function CredentialTypeViewEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CredentialTypeViewEntity.new(self._client, opts)
end
...
function CredentialTypeViewEntity:mark_deleted()
  self._deleted = true
end


function CredentialTypeViewEntity:deleted()
  return true == self._deleted
end


function CredentialTypeViewEntity:data_set(args)
  if args ~= nil then
...
function CredentialTypeViewEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CredentialTypeViewEntity:match_set(args)
  if args ~= nil then
...
function CredentialTypeViewEntity:match_get()
...
function CredentialTypeViewEntity:stream(action, args, callopts)
...
---@param reqmatch CredentialTypeViewListMatch
---@param ctrl? table
---@return CredentialTypeView[]
---@return string? err
function CredentialTypeViewEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CredentialTypeViewEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CredentialTypeViewEntity
