...
local ReissueCardEntity = {}
ReissueCardEntity.__index = ReissueCardEntity


function ReissueCardEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReissueCardEntity)
  self._name = "reissue_card"
  self._client = client
...
function ReissueCardEntity:get_name()
  return self._name
end


function ReissueCardEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ReissueCardEntity.new(self._client, opts)
end
...
function ReissueCardEntity:mark_deleted()
  self._deleted = true
end


function ReissueCardEntity:deleted()
  return true == self._deleted
end


function ReissueCardEntity:data_set(args)
  if args ~= nil then
...
function ReissueCardEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReissueCardEntity:match_set(args)
  if args ~= nil then
...
function ReissueCardEntity:match_get()
...
function ReissueCardEntity:stream(action, args, callopts)
...
---@param reqdata ReissueCardCreateData
---@param ctrl? table
---@return ReissueCard
---@return string? err
function ReissueCardEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ReissueCardEntity:_run_op(ctx, post_done)
  local utility = self._utility
