# Tangocard SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TangocardSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TangocardSDK(...) and TangocardSDK.test(...) become
#      TangocardSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "tangocard_sdk"
_SDK_CLASS = "TangocardSDK"
...
_ENTITIES = {
    "Account": "account",
    "AddCommentEscalation": "add_comment_escalation",
    "AllEventType": "all_event_type",
    "AsyncOrder": "async_order",
    "AsyncOrderDetailView": "async_order_detail_view",
    "AsyncOrderLineItemsView": "async_order_line_items_view",
    "AsyncReasonCodesView": "async_reason_codes_view",
    "AsyncUpdateLineItemView": "async_update_line_item_view",
    "BalanceAlertView": "balance_alert_view",
    "BrandCategoriesView": "brand_categories_view",
    "Catalog": "catalog",
    "ChoiceProduct": "choice_product",
    "CountryViewSummary": "country_view_summary",
    "CreateAccountCriterion": "create_account_criterion",
    "CreateCustomerCriterion": "create_customer_criterion",
    "CredentialTypeView": "credential_type_view",
    "CreditCard": "credit_card",
    "CreditCardDeposit": "credit_card_deposit",
    "CreditCardUnregister": "credit_card_unregister",
    "Customer": "customer",
    "EmailTemplateListView": "email_template_list_view",
    "EmailTemplateViewVerbose": "email_template_view_verbose",
    "EmbeddableResponseDto": "embeddable_response_dto",
    "ExchangeRatesWithDisclaimer": "exchange_rates_with_disclaimer",
    "LineItem": "line_item",
    "LowBalanceAlertListView": "low_balance_alert_list_view",
    "LowBalanceAlertView": "low_balance_alert_view",
    "MobileCountry": "mobile_country",
    "N14Webhook": "n14_webhook",
    "N1Customer": "n1_customer",
    "N2Account": "n2_account",
    "N3Fund": "n3_fund",
    "N8LineItem": "n8_line_item",
    "N9DigitalTemplate": "n9_digital_template",
    "Order": "order",
    "OrderViewSummary": "order_view_summary",
    "PrepaidCardInfo": "prepaid_card_info",
    "PrepaidCardTransaction": "prepaid_card_transaction",
    "ReissueCard": "reissue_card",
    "ReplacementReason": "replacement_reason",
    "Resend": "resend",
    "RewardReasonsMap": "reward_reasons_map",
    "TransferFund": "transfer_fund",
    "UpdateAccount": "update_account",
    "UpdateWebhookSubscriptionResponseView": "update_webhook_subscription_response_view",
    "Webhook": "webhook",
}
