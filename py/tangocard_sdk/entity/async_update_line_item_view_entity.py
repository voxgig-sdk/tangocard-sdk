...
class AsyncUpdateLineItemViewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AsyncUpdateLineItemViewEntity(self._client, opts)
    ...
    def data_get(self) -> AsyncUpdateLineItemView:
    ...
    def match_get(self) -> AsyncUpdateLineItemView:
    ...
    def update(self, reqdata: AsyncUpdateLineItemViewUpdateData, ctrl=None) -> AsyncUpdateLineItemView:
        utility = self._utility
