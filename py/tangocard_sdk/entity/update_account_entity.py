...
class UpdateAccountEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UpdateAccountEntity(self._client, opts)
    ...
    def data_get(self) -> UpdateAccount:
    ...
    def match_get(self) -> UpdateAccount:
    ...
    def create(self, reqdata: UpdateAccountCreateData, ctrl=None) -> UpdateAccount:
        utility = self._utility
