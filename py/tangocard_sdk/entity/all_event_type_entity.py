...
class AllEventTypeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AllEventTypeEntity(self._client, opts)
    ...
    def data_get(self) -> AllEventType:
    ...
    def match_get(self) -> AllEventType:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AllEventType]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AllEventType().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
