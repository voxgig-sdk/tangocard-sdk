...
class ReplacementReasonEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReplacementReasonEntity(self._client, opts)
    ...
    def data_get(self) -> ReplacementReason:
    ...
    def match_get(self) -> ReplacementReason:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ReplacementReason]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ReplacementReason().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
