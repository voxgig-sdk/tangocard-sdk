...
class OrderViewSummaryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrderViewSummaryEntity(self._client, opts)
    ...
    def data_get(self) -> OrderViewSummary:
    ...
    def match_get(self) -> OrderViewSummary:
    ...
    def create(self, reqdata: OrderViewSummaryCreateData, ctrl=None) -> OrderViewSummary:
        utility = self._utility
