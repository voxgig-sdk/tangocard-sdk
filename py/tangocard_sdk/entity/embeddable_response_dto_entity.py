...
class EmbeddableResponseDtoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmbeddableResponseDtoEntity(self._client, opts)
    ...
    def data_get(self) -> EmbeddableResponseDto:
    ...
    def match_get(self) -> EmbeddableResponseDto:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EmbeddableResponseDto:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EmbeddableResponseDto().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
