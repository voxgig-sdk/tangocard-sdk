...
class N8LineItemEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return N8LineItemEntity(self._client, opts)
    ...
    def update(self, reqdata: N8LineItemUpdateData, ctrl=None) -> N8LineItem:
        utility = self._utility
