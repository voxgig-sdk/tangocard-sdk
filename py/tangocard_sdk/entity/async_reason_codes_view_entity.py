...
class AsyncReasonCodesViewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AsyncReasonCodesViewEntity(self._client, opts)
    ...
    def data_get(self) -> AsyncReasonCodesView:
    ...
    def match_get(self) -> AsyncReasonCodesView:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AsyncReasonCodesView:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AsyncReasonCodesView().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
