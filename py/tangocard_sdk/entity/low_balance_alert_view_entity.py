...
class LowBalanceAlertViewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LowBalanceAlertViewEntity(self._client, opts)
    ...
    def data_get(self) -> LowBalanceAlertView:
    ...
    def match_get(self) -> LowBalanceAlertView:
    ...
    def load(self, reqmatch=None, ctrl=None) -> LowBalanceAlertView:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.LowBalanceAlertView().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: LowBalanceAlertViewCreateData, ctrl=None) -> LowBalanceAlertView:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: LowBalanceAlertViewUpdateData, ctrl=None) -> LowBalanceAlertView:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
