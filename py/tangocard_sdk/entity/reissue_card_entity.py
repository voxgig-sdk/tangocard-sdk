...
class ReissueCardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReissueCardEntity(self._client, opts)
    ...
    def match_get(self) -> ReissueCard:
    ...
    def create(self, reqdata: ReissueCardCreateData, ctrl=None) -> ReissueCard:
        utility = self._utility
