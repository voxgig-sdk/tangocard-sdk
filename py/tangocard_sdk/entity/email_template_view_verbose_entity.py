...
class EmailTemplateViewVerboseEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmailTemplateViewVerboseEntity(self._client, opts)
    ...
    def data_get(self) -> EmailTemplateViewVerbose:
    ...
    def match_get(self) -> EmailTemplateViewVerbose:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EmailTemplateViewVerbose:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EmailTemplateViewVerbose().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EmailTemplateViewVerbose]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EmailTemplateViewVerbose().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: EmailTemplateViewVerboseCreateData, ctrl=None) -> EmailTemplateViewVerbose:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: EmailTemplateViewVerboseUpdateData, ctrl=None) -> EmailTemplateViewVerbose:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
