...
class AsyncOrderLineItemsViewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AsyncOrderLineItemsViewEntity(self._client, opts)
    ...
    def data_get(self) -> AsyncOrderLineItemsView:
    ...
    def match_get(self) -> AsyncOrderLineItemsView:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AsyncOrderLineItemsView]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AsyncOrderLineItemsView().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
