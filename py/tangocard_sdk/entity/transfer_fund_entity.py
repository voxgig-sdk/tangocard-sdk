...
class TransferFundEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TransferFundEntity(self._client, opts)
    ...
    def data_get(self) -> TransferFund:
    ...
    def match_get(self) -> TransferFund:
    ...
    def create(self, reqdata: TransferFundCreateData, ctrl=None) -> TransferFund:
        utility = self._utility
