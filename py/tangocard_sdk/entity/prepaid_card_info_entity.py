...
class PrepaidCardInfoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PrepaidCardInfoEntity(self._client, opts)
    ...
    def data_get(self) -> PrepaidCardInfo:
    ...
    def match_get(self) -> PrepaidCardInfo:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PrepaidCardInfo:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PrepaidCardInfo().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
