...
class RewardReasonsMapEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RewardReasonsMapEntity(self._client, opts)
    ...
    def data_get(self) -> RewardReasonsMap:
    ...
    def match_get(self) -> RewardReasonsMap:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RewardReasonsMap:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RewardReasonsMap().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
