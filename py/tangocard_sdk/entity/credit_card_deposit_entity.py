...
class CreditCardDepositEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreditCardDepositEntity(self._client, opts)
    ...
    def data_get(self) -> CreditCardDeposit:
    ...
    def match_get(self) -> CreditCardDeposit:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CreditCardDeposit:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CreditCardDeposit().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: CreditCardDepositCreateData, ctrl=None) -> CreditCardDeposit:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
