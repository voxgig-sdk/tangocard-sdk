...
class PrepaidCardTransactionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PrepaidCardTransactionEntity(self._client, opts)
    ...
    def data_get(self) -> PrepaidCardTransaction:
    ...
    def match_get(self) -> PrepaidCardTransaction:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PrepaidCardTransaction:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PrepaidCardTransaction().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
