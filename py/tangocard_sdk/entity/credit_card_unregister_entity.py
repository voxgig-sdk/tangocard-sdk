...
class CreditCardUnregisterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreditCardUnregisterEntity(self._client, opts)
    ...
    def data_get(self) -> CreditCardUnregister:
    ...
    def match_get(self) -> CreditCardUnregister:
    ...
    def create(self, reqdata: CreditCardUnregisterCreateData, ctrl=None) -> CreditCardUnregister:
        utility = self._utility
