...
class ExchangeRatesWithDisclaimerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ExchangeRatesWithDisclaimerEntity(self._client, opts)
    ...
    def data_get(self) -> ExchangeRatesWithDisclaimer:
    ...
    def match_get(self) -> ExchangeRatesWithDisclaimer:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ExchangeRatesWithDisclaimer]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ExchangeRatesWithDisclaimer().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
