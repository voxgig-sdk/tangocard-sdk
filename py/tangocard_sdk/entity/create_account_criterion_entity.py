...
class CreateAccountCriterionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreateAccountCriterionEntity(self._client, opts)
    ...
    def data_get(self) -> CreateAccountCriterion:
    ...
    def match_get(self) -> CreateAccountCriterion:
    ...
    def create(self, reqdata: CreateAccountCriterionCreateData, ctrl=None) -> CreateAccountCriterion:
        utility = self._utility
