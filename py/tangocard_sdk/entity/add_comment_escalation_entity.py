...
class AddCommentEscalationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AddCommentEscalationEntity(self._client, opts)
    ...
    def data_get(self) -> AddCommentEscalation:
    ...
    def match_get(self) -> AddCommentEscalation:
    ...
    def create(self, reqdata: AddCommentEscalationCreateData, ctrl=None) -> AddCommentEscalation:
        utility = self._utility
