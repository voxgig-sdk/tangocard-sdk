...
class UpdateWebhookSubscriptionResponseViewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UpdateWebhookSubscriptionResponseViewEntity(self._client, opts)
    ...
    def data_get(self) -> UpdateWebhookSubscriptionResponseView:
    ...
    def match_get(self) -> UpdateWebhookSubscriptionResponseView:
    ...
    def update(self, reqdata: UpdateWebhookSubscriptionResponseViewUpdateData, ctrl=None) -> UpdateWebhookSubscriptionResponseView:
        utility = self._utility
