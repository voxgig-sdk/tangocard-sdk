...
class CredentialTypeViewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CredentialTypeViewEntity(self._client, opts)
    ...
    def data_get(self) -> CredentialTypeView:
    ...
    def match_get(self) -> CredentialTypeView:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CredentialTypeView]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CredentialTypeView().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
