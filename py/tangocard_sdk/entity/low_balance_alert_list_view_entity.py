...
class LowBalanceAlertListViewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LowBalanceAlertListViewEntity(self._client, opts)
    ...
    def data_get(self) -> LowBalanceAlertListView:
    ...
    def match_get(self) -> LowBalanceAlertListView:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[LowBalanceAlertListView]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.LowBalanceAlertListView().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
