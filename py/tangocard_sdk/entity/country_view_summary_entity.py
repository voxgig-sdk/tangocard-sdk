...
class CountryViewSummaryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CountryViewSummaryEntity(self._client, opts)
    ...
    def data_get(self) -> CountryViewSummary:
    ...
    def match_get(self) -> CountryViewSummary:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CountryViewSummary:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CountryViewSummary().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
