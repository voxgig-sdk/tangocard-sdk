...
class BrandCategoriesViewEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BrandCategoriesViewEntity(self._client, opts)
    ...
    def data_get(self) -> BrandCategoriesView:
    ...
    def match_get(self) -> BrandCategoriesView:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[BrandCategoriesView]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.BrandCategoriesView().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
