...
type AllEventTypeEntity struct {
	name    string
...
func NewAllEventTypeEntity(client *core.TangocardSDK, entopts map[string]any) *AllEventTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AllEventTypeEntity) GetName() string { return e.name }
...
func (e *AllEventTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AllEventTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *AllEventTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAllEventTypeEntity(e.client, opts)
}

func (e *AllEventTypeEntity) Data(args ...any) any {
...
func (e *AllEventTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AllEventType; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AllEventTypeEntity) DataTyped(data ...AllEventType) AllEventType {
	if len(data) > 0 {
		return typedFrom[AllEventType](e.Data(asMap(data[0])))
	}
	return typedFrom[AllEventType](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AllEventType (all fields
// optional at the wire level).
func (e *AllEventTypeEntity) MatchTyped(match ...AllEventType) AllEventType {
	if len(match) > 0 {
		return typedFrom[AllEventType](e.Match(asMap(match[0])))
	}
	return typedFrom[AllEventType](e.Match())
}
...
func (e *AllEventTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AllEventTypeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AllEventTypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AllEventTypeListMatch and returns []AllEventType. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AllEventTypeEntity) ListTyped(reqmatch AllEventTypeListMatch, ctrl map[string]any) ([]AllEventType, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AllEventType](res), nil
}



func (e *AllEventTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AllEventTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AllEventTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AllEventTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
