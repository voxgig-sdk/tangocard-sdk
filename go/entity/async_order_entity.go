...
func NewAsyncOrderEntity(client *core.TangocardSDK, entopts map[string]any) *AsyncOrderEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AsyncOrderEntity) GetName() string { return e.name }
...
func (e *AsyncOrderEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AsyncOrderEntity) Deleted() bool {
	return e.deleted
}


func (e *AsyncOrderEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAsyncOrderEntity(e.client, opts)
}

func (e *AsyncOrderEntity) Data(args ...any) any {
...
func (e *AsyncOrderEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AsyncOrder; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AsyncOrderEntity) DataTyped(data ...AsyncOrder) AsyncOrder {
	if len(data) > 0 {
		return typedFrom[AsyncOrder](e.Data(asMap(data[0])))
	}
	return typedFrom[AsyncOrder](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AsyncOrder (all fields
// optional at the wire level).
func (e *AsyncOrderEntity) MatchTyped(match ...AsyncOrder) AsyncOrder {
	if len(match) > 0 {
		return typedFrom[AsyncOrder](e.Match(asMap(match[0])))
	}
	return typedFrom[AsyncOrder](e.Match())
}
...
func (e *AsyncOrderEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AsyncOrderEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AsyncOrderEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AsyncOrderListMatch and returns []AsyncOrder. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AsyncOrderEntity) ListTyped(reqmatch AsyncOrderListMatch, ctrl map[string]any) ([]AsyncOrder, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AsyncOrder](res), nil
}




func (e *AsyncOrderEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AsyncOrderCreateData and returns an AsyncOrder. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AsyncOrderEntity) CreateTyped(reqdata AsyncOrderCreateData, ctrl map[string]any) (AsyncOrder, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return AsyncOrder{}, err
	}
	return typedFrom[AsyncOrder](res), nil
}



func (e *AsyncOrderEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AsyncOrderEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AsyncOrderEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
