...
type ReplacementReasonEntity struct {
	name    string
...
func NewReplacementReasonEntity(client *core.TangocardSDK, entopts map[string]any) *ReplacementReasonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReplacementReasonEntity) GetName() string { return e.name }
...
func (e *ReplacementReasonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReplacementReasonEntity) Deleted() bool {
	return e.deleted
}


func (e *ReplacementReasonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReplacementReasonEntity(e.client, opts)
}

func (e *ReplacementReasonEntity) Data(args ...any) any {
...
func (e *ReplacementReasonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReplacementReason; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReplacementReasonEntity) DataTyped(data ...ReplacementReason) ReplacementReason {
	if len(data) > 0 {
		return typedFrom[ReplacementReason](e.Data(asMap(data[0])))
	}
	return typedFrom[ReplacementReason](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReplacementReason (all fields
// optional at the wire level).
func (e *ReplacementReasonEntity) MatchTyped(match ...ReplacementReason) ReplacementReason {
	if len(match) > 0 {
		return typedFrom[ReplacementReason](e.Match(asMap(match[0])))
	}
	return typedFrom[ReplacementReason](e.Match())
}
...
func (e *ReplacementReasonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReplacementReasonEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ReplacementReasonEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReplacementReasonListMatch and returns []ReplacementReason. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ReplacementReasonEntity) ListTyped(reqmatch ReplacementReasonListMatch, ctrl map[string]any) ([]ReplacementReason, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ReplacementReason](res), nil
}



func (e *ReplacementReasonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReplacementReasonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReplacementReasonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReplacementReasonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
