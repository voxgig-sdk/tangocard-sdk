...
type UpdateAccountEntity struct {
	name    string
...
func NewUpdateAccountEntity(client *core.TangocardSDK, entopts map[string]any) *UpdateAccountEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UpdateAccountEntity) GetName() string { return e.name }
...
func (e *UpdateAccountEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UpdateAccountEntity) Deleted() bool {
	return e.deleted
}


func (e *UpdateAccountEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUpdateAccountEntity(e.client, opts)
}

func (e *UpdateAccountEntity) Data(args ...any) any {
...
func (e *UpdateAccountEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UpdateAccount; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UpdateAccountEntity) DataTyped(data ...UpdateAccount) UpdateAccount {
	if len(data) > 0 {
		return typedFrom[UpdateAccount](e.Data(asMap(data[0])))
	}
	return typedFrom[UpdateAccount](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UpdateAccount (all fields
// optional at the wire level).
func (e *UpdateAccountEntity) MatchTyped(match ...UpdateAccount) UpdateAccount {
	if len(match) > 0 {
		return typedFrom[UpdateAccount](e.Match(asMap(match[0])))
	}
	return typedFrom[UpdateAccount](e.Match())
}
...
func (e *UpdateAccountEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UpdateAccountEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *UpdateAccountEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UpdateAccountEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UpdateAccountCreateData and returns an UpdateAccount. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UpdateAccountEntity) CreateTyped(reqdata UpdateAccountCreateData, ctrl map[string]any) (UpdateAccount, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return UpdateAccount{}, err
	}
	return typedFrom[UpdateAccount](res), nil
}



func (e *UpdateAccountEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UpdateAccountEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UpdateAccountEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
