...
type BalanceAlertViewEntity struct {
	name    string
...
func NewBalanceAlertViewEntity(client *core.TangocardSDK, entopts map[string]any) *BalanceAlertViewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BalanceAlertViewEntity) GetName() string { return e.name }
...
func (e *BalanceAlertViewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BalanceAlertViewEntity) Deleted() bool {
	return e.deleted
}


func (e *BalanceAlertViewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBalanceAlertViewEntity(e.client, opts)
}

func (e *BalanceAlertViewEntity) Data(args ...any) any {
...
func (e *BalanceAlertViewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BalanceAlertView; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BalanceAlertViewEntity) DataTyped(data ...BalanceAlertView) BalanceAlertView {
	if len(data) > 0 {
		return typedFrom[BalanceAlertView](e.Data(asMap(data[0])))
	}
	return typedFrom[BalanceAlertView](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BalanceAlertView (all fields
// optional at the wire level).
func (e *BalanceAlertViewEntity) MatchTyped(match ...BalanceAlertView) BalanceAlertView {
	if len(match) > 0 {
		return typedFrom[BalanceAlertView](e.Match(asMap(match[0])))
	}
	return typedFrom[BalanceAlertView](e.Match())
}
...
func (e *BalanceAlertViewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BalanceAlertViewEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BalanceAlertViewEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BalanceAlertViewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BalanceAlertViewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *BalanceAlertViewEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BalanceAlertViewRemoveMatch and returns an BalanceAlertView. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *BalanceAlertViewEntity) RemoveTyped(reqmatch BalanceAlertViewRemoveMatch, ctrl map[string]any) (BalanceAlertView, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return BalanceAlertView{}, err
	}
	return typedFrom[BalanceAlertView](res), nil
}



func (e *BalanceAlertViewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
