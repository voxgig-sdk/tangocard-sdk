...
func NewCreditCardEntity(client *core.TangocardSDK, entopts map[string]any) *CreditCardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CreditCardEntity) GetName() string { return e.name }
...
func (e *CreditCardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CreditCardEntity) Deleted() bool {
	return e.deleted
}


func (e *CreditCardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCreditCardEntity(e.client, opts)
}

func (e *CreditCardEntity) Data(args ...any) any {
...
func (e *CreditCardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CreditCard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CreditCardEntity) DataTyped(data ...CreditCard) CreditCard {
	if len(data) > 0 {
		return typedFrom[CreditCard](e.Data(asMap(data[0])))
	}
	return typedFrom[CreditCard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CreditCard (all fields
// optional at the wire level).
func (e *CreditCardEntity) MatchTyped(match ...CreditCard) CreditCard {
	if len(match) > 0 {
		return typedFrom[CreditCard](e.Match(asMap(match[0])))
	}
	return typedFrom[CreditCard](e.Match())
}
...
func (e *CreditCardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CreditCardEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CreditCardLoadMatch and returns an CreditCard. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CreditCardEntity) LoadTyped(reqmatch CreditCardLoadMatch, ctrl map[string]any) (CreditCard, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CreditCard{}, err
	}
	return typedFrom[CreditCard](res), nil
}



func (e *CreditCardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CreditCardEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CreditCardCreateData and returns an CreditCard. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CreditCardEntity) CreateTyped(reqdata CreditCardCreateData, ctrl map[string]any) (CreditCard, error) {
...
func (e *CreditCardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CreditCardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CreditCardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
