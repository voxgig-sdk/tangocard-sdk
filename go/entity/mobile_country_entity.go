...
type MobileCountryEntity struct {
	name    string
...
func NewMobileCountryEntity(client *core.TangocardSDK, entopts map[string]any) *MobileCountryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MobileCountryEntity) GetName() string { return e.name }
...
func (e *MobileCountryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MobileCountryEntity) Deleted() bool {
	return e.deleted
}


func (e *MobileCountryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMobileCountryEntity(e.client, opts)
}

func (e *MobileCountryEntity) Data(args ...any) any {
...
func (e *MobileCountryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MobileCountry; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MobileCountryEntity) DataTyped(data ...MobileCountry) MobileCountry {
	if len(data) > 0 {
		return typedFrom[MobileCountry](e.Data(asMap(data[0])))
	}
	return typedFrom[MobileCountry](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MobileCountry (all fields
// optional at the wire level).
func (e *MobileCountryEntity) MatchTyped(match ...MobileCountry) MobileCountry {
	if len(match) > 0 {
		return typedFrom[MobileCountry](e.Match(asMap(match[0])))
	}
	return typedFrom[MobileCountry](e.Match())
}
...
func (e *MobileCountryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MobileCountryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MobileCountryLoadMatch and returns an MobileCountry. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MobileCountryEntity) LoadTyped(reqmatch MobileCountryLoadMatch, ctrl map[string]any) (MobileCountry, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MobileCountry{}, err
	}
	return typedFrom[MobileCountry](res), nil
}



func (e *MobileCountryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MobileCountryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MobileCountryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MobileCountryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MobileCountryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
