...
type N9DigitalTemplateEntity struct {
	name    string
...
func NewN9DigitalTemplateEntity(client *core.TangocardSDK, entopts map[string]any) *N9DigitalTemplateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *N9DigitalTemplateEntity) GetName() string { return e.name }
...
func (e *N9DigitalTemplateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *N9DigitalTemplateEntity) Deleted() bool {
	return e.deleted
}


func (e *N9DigitalTemplateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewN9DigitalTemplateEntity(e.client, opts)
}

func (e *N9DigitalTemplateEntity) Data(args ...any) any {
...
func (e *N9DigitalTemplateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an N9DigitalTemplate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *N9DigitalTemplateEntity) DataTyped(data ...N9DigitalTemplate) N9DigitalTemplate {
	if len(data) > 0 {
		return typedFrom[N9DigitalTemplate](e.Data(asMap(data[0])))
	}
	return typedFrom[N9DigitalTemplate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through N9DigitalTemplate (all fields
// optional at the wire level).
func (e *N9DigitalTemplateEntity) MatchTyped(match ...N9DigitalTemplate) N9DigitalTemplate {
	if len(match) > 0 {
		return typedFrom[N9DigitalTemplate](e.Match(asMap(match[0])))
	}
	return typedFrom[N9DigitalTemplate](e.Match())
}
...
func (e *N9DigitalTemplateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *N9DigitalTemplateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *N9DigitalTemplateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *N9DigitalTemplateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *N9DigitalTemplateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *N9DigitalTemplateEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// N9DigitalTemplateRemoveMatch and returns an N9DigitalTemplate. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *N9DigitalTemplateEntity) RemoveTyped(reqmatch N9DigitalTemplateRemoveMatch, ctrl map[string]any) (N9DigitalTemplate, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return N9DigitalTemplate{}, err
	}
	return typedFrom[N9DigitalTemplate](res), nil
}



func (e *N9DigitalTemplateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
