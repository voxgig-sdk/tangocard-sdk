...
func NewN2AccountEntity(client *core.TangocardSDK, entopts map[string]any) *N2AccountEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *N2AccountEntity) GetName() string { return e.name }
...
func (e *N2AccountEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *N2AccountEntity) Deleted() bool {
	return e.deleted
}


func (e *N2AccountEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewN2AccountEntity(e.client, opts)
}

func (e *N2AccountEntity) Data(args ...any) any {
...
func (e *N2AccountEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an N2Account; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *N2AccountEntity) DataTyped(data ...N2Account) N2Account {
	if len(data) > 0 {
		return typedFrom[N2Account](e.Data(asMap(data[0])))
	}
	return typedFrom[N2Account](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through N2Account (all fields
// optional at the wire level).
func (e *N2AccountEntity) MatchTyped(match ...N2Account) N2Account {
	if len(match) > 0 {
		return typedFrom[N2Account](e.Match(asMap(match[0])))
	}
	return typedFrom[N2Account](e.Match())
}
...
func (e *N2AccountEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *N2AccountEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *N2AccountEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *N2AccountEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *N2AccountEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *N2AccountEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *N2AccountEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
