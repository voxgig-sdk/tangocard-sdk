...
func NewN8LineItemEntity(client *core.TangocardSDK, entopts map[string]any) *N8LineItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *N8LineItemEntity) GetName() string { return e.name }
...
func (e *N8LineItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *N8LineItemEntity) Deleted() bool {
	return e.deleted
}


func (e *N8LineItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewN8LineItemEntity(e.client, opts)
}

func (e *N8LineItemEntity) Data(args ...any) any {
...
func (e *N8LineItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an N8LineItem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *N8LineItemEntity) DataTyped(data ...N8LineItem) N8LineItem {
	if len(data) > 0 {
		return typedFrom[N8LineItem](e.Data(asMap(data[0])))
	}
	return typedFrom[N8LineItem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through N8LineItem (all fields
// optional at the wire level).
func (e *N8LineItemEntity) MatchTyped(match ...N8LineItem) N8LineItem {
	if len(match) > 0 {
		return typedFrom[N8LineItem](e.Match(asMap(match[0])))
	}
	return typedFrom[N8LineItem](e.Match())
}
...
func (e *N8LineItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *N8LineItemEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *N8LineItemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *N8LineItemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *N8LineItemEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// N8LineItemUpdateData and returns an N8LineItem. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *N8LineItemEntity) UpdateTyped(reqdata N8LineItemUpdateData, ctrl map[string]any) (N8LineItem, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return N8LineItem{}, err
	}
	return typedFrom[N8LineItem](res), nil
}



func (e *N8LineItemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *N8LineItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
