...
type CredentialTypeViewEntity struct {
	name    string
...
func NewCredentialTypeViewEntity(client *core.TangocardSDK, entopts map[string]any) *CredentialTypeViewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CredentialTypeViewEntity) GetName() string { return e.name }
...
func (e *CredentialTypeViewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CredentialTypeViewEntity) Deleted() bool {
	return e.deleted
}


func (e *CredentialTypeViewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCredentialTypeViewEntity(e.client, opts)
}

func (e *CredentialTypeViewEntity) Data(args ...any) any {
...
func (e *CredentialTypeViewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CredentialTypeView; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CredentialTypeViewEntity) DataTyped(data ...CredentialTypeView) CredentialTypeView {
	if len(data) > 0 {
		return typedFrom[CredentialTypeView](e.Data(asMap(data[0])))
	}
	return typedFrom[CredentialTypeView](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CredentialTypeView (all fields
// optional at the wire level).
func (e *CredentialTypeViewEntity) MatchTyped(match ...CredentialTypeView) CredentialTypeView {
	if len(match) > 0 {
		return typedFrom[CredentialTypeView](e.Match(asMap(match[0])))
	}
	return typedFrom[CredentialTypeView](e.Match())
}
...
func (e *CredentialTypeViewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CredentialTypeViewEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CredentialTypeViewEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CredentialTypeViewListMatch and returns []CredentialTypeView. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CredentialTypeViewEntity) ListTyped(reqmatch CredentialTypeViewListMatch, ctrl map[string]any) ([]CredentialTypeView, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CredentialTypeView](res), nil
}



func (e *CredentialTypeViewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CredentialTypeViewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CredentialTypeViewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CredentialTypeViewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
