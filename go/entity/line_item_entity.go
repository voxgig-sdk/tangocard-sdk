...
func NewLineItemEntity(client *core.TangocardSDK, entopts map[string]any) *LineItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LineItemEntity) GetName() string { return e.name }
...
func (e *LineItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LineItemEntity) Deleted() bool {
	return e.deleted
}


func (e *LineItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLineItemEntity(e.client, opts)
}

func (e *LineItemEntity) Data(args ...any) any {
...
func (e *LineItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LineItem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LineItemEntity) DataTyped(data ...LineItem) LineItem {
	if len(data) > 0 {
		return typedFrom[LineItem](e.Data(asMap(data[0])))
	}
	return typedFrom[LineItem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LineItem (all fields
// optional at the wire level).
func (e *LineItemEntity) MatchTyped(match ...LineItem) LineItem {
	if len(match) > 0 {
		return typedFrom[LineItem](e.Match(asMap(match[0])))
	}
	return typedFrom[LineItem](e.Match())
}
...
func (e *LineItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LineItemEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LineItemLoadMatch and returns an LineItem. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LineItemEntity) LoadTyped(reqmatch LineItemLoadMatch, ctrl map[string]any) (LineItem, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return LineItem{}, err
	}
	return typedFrom[LineItem](res), nil
}




func (e *LineItemEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LineItemListMatch and returns []LineItem. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LineItemEntity) ListTyped(reqmatch LineItemListMatch, ctrl map[string]any) ([]LineItem, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[LineItem](res), nil
}




func (e *LineItemEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// LineItemCreateData and returns an LineItem. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *LineItemEntity) CreateTyped(reqdata LineItemCreateData, ctrl map[string]any) (LineItem, error) {
...
func (e *LineItemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LineItemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LineItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
