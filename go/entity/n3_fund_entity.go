...
func NewN3FundEntity(client *core.TangocardSDK, entopts map[string]any) *N3FundEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *N3FundEntity) GetName() string { return e.name }
...
func (e *N3FundEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *N3FundEntity) Deleted() bool {
	return e.deleted
}


func (e *N3FundEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewN3FundEntity(e.client, opts)
}

func (e *N3FundEntity) Data(args ...any) any {
...
func (e *N3FundEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an N3Fund; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *N3FundEntity) DataTyped(data ...N3Fund) N3Fund {
	if len(data) > 0 {
		return typedFrom[N3Fund](e.Data(asMap(data[0])))
	}
	return typedFrom[N3Fund](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through N3Fund (all fields
// optional at the wire level).
func (e *N3FundEntity) MatchTyped(match ...N3Fund) N3Fund {
	if len(match) > 0 {
		return typedFrom[N3Fund](e.Match(asMap(match[0])))
	}
	return typedFrom[N3Fund](e.Match())
}
...
func (e *N3FundEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *N3FundEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *N3FundEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *N3FundEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *N3FundEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *N3FundEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *N3FundEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
