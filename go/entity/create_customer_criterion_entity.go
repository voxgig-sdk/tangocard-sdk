...
type CreateCustomerCriterionEntity struct {
	name    string
...
func NewCreateCustomerCriterionEntity(client *core.TangocardSDK, entopts map[string]any) *CreateCustomerCriterionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &CreateCustomerCriterionEntity{
...
func (e *CreateCustomerCriterionEntity) GetName() string { return e.name }
...
func (e *CreateCustomerCriterionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CreateCustomerCriterionEntity) Deleted() bool {
	return e.deleted
}


func (e *CreateCustomerCriterionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCreateCustomerCriterionEntity(e.client, opts)
}

func (e *CreateCustomerCriterionEntity) Data(args ...any) any {
...
func (e *CreateCustomerCriterionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CreateCustomerCriterion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CreateCustomerCriterionEntity) DataTyped(data ...CreateCustomerCriterion) CreateCustomerCriterion {
	if len(data) > 0 {
		return typedFrom[CreateCustomerCriterion](e.Data(asMap(data[0])))
	}
	return typedFrom[CreateCustomerCriterion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CreateCustomerCriterion (all fields
// optional at the wire level).
func (e *CreateCustomerCriterionEntity) MatchTyped(match ...CreateCustomerCriterion) CreateCustomerCriterion {
	if len(match) > 0 {
		return typedFrom[CreateCustomerCriterion](e.Match(asMap(match[0])))
	}
	return typedFrom[CreateCustomerCriterion](e.Match())
}
...
func (e *CreateCustomerCriterionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CreateCustomerCriterionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CreateCustomerCriterionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CreateCustomerCriterionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CreateCustomerCriterionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CreateCustomerCriterionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CreateCustomerCriterionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
