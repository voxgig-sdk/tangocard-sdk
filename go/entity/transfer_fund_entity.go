...
type TransferFundEntity struct {
	name    string
...
func NewTransferFundEntity(client *core.TangocardSDK, entopts map[string]any) *TransferFundEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TransferFundEntity) GetName() string { return e.name }
...
func (e *TransferFundEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TransferFundEntity) Deleted() bool {
	return e.deleted
}


func (e *TransferFundEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTransferFundEntity(e.client, opts)
}

func (e *TransferFundEntity) Data(args ...any) any {
...
func (e *TransferFundEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TransferFund; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TransferFundEntity) DataTyped(data ...TransferFund) TransferFund {
	if len(data) > 0 {
		return typedFrom[TransferFund](e.Data(asMap(data[0])))
	}
	return typedFrom[TransferFund](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TransferFund (all fields
// optional at the wire level).
func (e *TransferFundEntity) MatchTyped(match ...TransferFund) TransferFund {
	if len(match) > 0 {
		return typedFrom[TransferFund](e.Match(asMap(match[0])))
	}
	return typedFrom[TransferFund](e.Match())
}
...
func (e *TransferFundEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TransferFundEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TransferFundEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TransferFundEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TransferFundCreateData and returns an TransferFund. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TransferFundEntity) CreateTyped(reqdata TransferFundCreateData, ctrl map[string]any) (TransferFund, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return TransferFund{}, err
	}
	return typedFrom[TransferFund](res), nil
}



func (e *TransferFundEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TransferFundEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TransferFundEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
