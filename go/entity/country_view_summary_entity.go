...
type CountryViewSummaryEntity struct {
	name    string
...
func NewCountryViewSummaryEntity(client *core.TangocardSDK, entopts map[string]any) *CountryViewSummaryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CountryViewSummaryEntity) GetName() string { return e.name }
...
func (e *CountryViewSummaryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CountryViewSummaryEntity) Deleted() bool {
	return e.deleted
}


func (e *CountryViewSummaryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCountryViewSummaryEntity(e.client, opts)
}

func (e *CountryViewSummaryEntity) Data(args ...any) any {
...
func (e *CountryViewSummaryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CountryViewSummary; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CountryViewSummaryEntity) DataTyped(data ...CountryViewSummary) CountryViewSummary {
	if len(data) > 0 {
		return typedFrom[CountryViewSummary](e.Data(asMap(data[0])))
	}
	return typedFrom[CountryViewSummary](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CountryViewSummary (all fields
// optional at the wire level).
func (e *CountryViewSummaryEntity) MatchTyped(match ...CountryViewSummary) CountryViewSummary {
	if len(match) > 0 {
		return typedFrom[CountryViewSummary](e.Match(asMap(match[0])))
	}
	return typedFrom[CountryViewSummary](e.Match())
}
...
func (e *CountryViewSummaryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CountryViewSummaryEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CountryViewSummaryLoadMatch and returns an CountryViewSummary. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CountryViewSummaryEntity) LoadTyped(reqmatch CountryViewSummaryLoadMatch, ctrl map[string]any) (CountryViewSummary, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CountryViewSummary{}, err
	}
	return typedFrom[CountryViewSummary](res), nil
}



func (e *CountryViewSummaryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CountryViewSummaryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CountryViewSummaryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CountryViewSummaryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CountryViewSummaryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
