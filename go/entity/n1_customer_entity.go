...
func NewN1CustomerEntity(client *core.TangocardSDK, entopts map[string]any) *N1CustomerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *N1CustomerEntity) GetName() string { return e.name }
...
func (e *N1CustomerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *N1CustomerEntity) Deleted() bool {
	return e.deleted
}


func (e *N1CustomerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewN1CustomerEntity(e.client, opts)
}

func (e *N1CustomerEntity) Data(args ...any) any {
...
func (e *N1CustomerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an N1Customer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *N1CustomerEntity) DataTyped(data ...N1Customer) N1Customer {
	if len(data) > 0 {
		return typedFrom[N1Customer](e.Data(asMap(data[0])))
	}
	return typedFrom[N1Customer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through N1Customer (all fields
// optional at the wire level).
func (e *N1CustomerEntity) MatchTyped(match ...N1Customer) N1Customer {
	if len(match) > 0 {
		return typedFrom[N1Customer](e.Match(asMap(match[0])))
	}
	return typedFrom[N1Customer](e.Match())
}
...
func (e *N1CustomerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *N1CustomerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// N1CustomerLoadMatch and returns an N1Customer. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *N1CustomerEntity) LoadTyped(reqmatch N1CustomerLoadMatch, ctrl map[string]any) (N1Customer, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return N1Customer{}, err
	}
	return typedFrom[N1Customer](res), nil
}



func (e *N1CustomerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *N1CustomerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *N1CustomerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *N1CustomerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *N1CustomerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
