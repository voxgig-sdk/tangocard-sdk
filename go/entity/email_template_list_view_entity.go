...
type EmailTemplateListViewEntity struct {
	name    string
...
func NewEmailTemplateListViewEntity(client *core.TangocardSDK, entopts map[string]any) *EmailTemplateListViewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmailTemplateListViewEntity) GetName() string { return e.name }
...
func (e *EmailTemplateListViewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmailTemplateListViewEntity) Deleted() bool {
	return e.deleted
}


func (e *EmailTemplateListViewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmailTemplateListViewEntity(e.client, opts)
}

func (e *EmailTemplateListViewEntity) Data(args ...any) any {
...
func (e *EmailTemplateListViewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EmailTemplateListView; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmailTemplateListViewEntity) DataTyped(data ...EmailTemplateListView) EmailTemplateListView {
	if len(data) > 0 {
		return typedFrom[EmailTemplateListView](e.Data(asMap(data[0])))
	}
	return typedFrom[EmailTemplateListView](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EmailTemplateListView (all fields
// optional at the wire level).
func (e *EmailTemplateListViewEntity) MatchTyped(match ...EmailTemplateListView) EmailTemplateListView {
	if len(match) > 0 {
		return typedFrom[EmailTemplateListView](e.Match(asMap(match[0])))
	}
	return typedFrom[EmailTemplateListView](e.Match())
}
...
func (e *EmailTemplateListViewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmailTemplateListViewEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EmailTemplateListViewEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EmailTemplateListViewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EmailTemplateListViewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EmailTemplateListViewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmailTemplateListViewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
