...
type OrderViewSummaryEntity struct {
	name    string
...
func NewOrderViewSummaryEntity(client *core.TangocardSDK, entopts map[string]any) *OrderViewSummaryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OrderViewSummaryEntity) GetName() string { return e.name }
...
func (e *OrderViewSummaryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OrderViewSummaryEntity) Deleted() bool {
	return e.deleted
}


func (e *OrderViewSummaryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOrderViewSummaryEntity(e.client, opts)
}

func (e *OrderViewSummaryEntity) Data(args ...any) any {
...
func (e *OrderViewSummaryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OrderViewSummary; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OrderViewSummaryEntity) DataTyped(data ...OrderViewSummary) OrderViewSummary {
	if len(data) > 0 {
		return typedFrom[OrderViewSummary](e.Data(asMap(data[0])))
	}
	return typedFrom[OrderViewSummary](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OrderViewSummary (all fields
// optional at the wire level).
func (e *OrderViewSummaryEntity) MatchTyped(match ...OrderViewSummary) OrderViewSummary {
	if len(match) > 0 {
		return typedFrom[OrderViewSummary](e.Match(asMap(match[0])))
	}
	return typedFrom[OrderViewSummary](e.Match())
}
...
func (e *OrderViewSummaryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OrderViewSummaryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OrderViewSummaryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OrderViewSummaryEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OrderViewSummaryCreateData and returns an OrderViewSummary. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OrderViewSummaryEntity) CreateTyped(reqdata OrderViewSummaryCreateData, ctrl map[string]any) (OrderViewSummary, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OrderViewSummary{}, err
	}
	return typedFrom[OrderViewSummary](res), nil
}



func (e *OrderViewSummaryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OrderViewSummaryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OrderViewSummaryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
