...
func NewResendEntity(client *core.TangocardSDK, entopts map[string]any) *ResendEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResendEntity) GetName() string { return e.name }
...
func (e *ResendEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ResendEntity) Deleted() bool {
	return e.deleted
}


func (e *ResendEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewResendEntity(e.client, opts)
}

func (e *ResendEntity) Data(args ...any) any {
...
func (e *ResendEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Resend; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ResendEntity) DataTyped(data ...Resend) Resend {
	if len(data) > 0 {
		return typedFrom[Resend](e.Data(asMap(data[0])))
	}
	return typedFrom[Resend](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Resend (all fields
// optional at the wire level).
func (e *ResendEntity) MatchTyped(match ...Resend) Resend {
	if len(match) > 0 {
		return typedFrom[Resend](e.Match(asMap(match[0])))
	}
	return typedFrom[Resend](e.Match())
}
...
func (e *ResendEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ResendEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ResendEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ResendEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ResendCreateData and returns an Resend. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ResendEntity) CreateTyped(reqdata ResendCreateData, ctrl map[string]any) (Resend, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Resend{}, err
	}
	return typedFrom[Resend](res), nil
}



func (e *ResendEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ResendEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ResendEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
