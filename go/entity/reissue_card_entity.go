...
func NewReissueCardEntity(client *core.TangocardSDK, entopts map[string]any) *ReissueCardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReissueCardEntity) GetName() string { return e.name }
...
func (e *ReissueCardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReissueCardEntity) Deleted() bool {
	return e.deleted
}


func (e *ReissueCardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReissueCardEntity(e.client, opts)
}

func (e *ReissueCardEntity) Data(args ...any) any {
...
func (e *ReissueCardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReissueCard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReissueCardEntity) DataTyped(data ...ReissueCard) ReissueCard {
	if len(data) > 0 {
		return typedFrom[ReissueCard](e.Data(asMap(data[0])))
	}
	return typedFrom[ReissueCard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReissueCard (all fields
// optional at the wire level).
func (e *ReissueCardEntity) MatchTyped(match ...ReissueCard) ReissueCard {
	if len(match) > 0 {
		return typedFrom[ReissueCard](e.Match(asMap(match[0])))
	}
	return typedFrom[ReissueCard](e.Match())
}
...
func (e *ReissueCardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReissueCardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ReissueCardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ReissueCardEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReissueCardCreateData and returns an ReissueCard. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ReissueCardEntity) CreateTyped(reqdata ReissueCardCreateData, ctrl map[string]any) (ReissueCard, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ReissueCard{}, err
	}
	return typedFrom[ReissueCard](res), nil
}



func (e *ReissueCardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReissueCardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReissueCardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
