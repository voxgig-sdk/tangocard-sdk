...
type RewardReasonsMapEntity struct {
	name    string
...
func NewRewardReasonsMapEntity(client *core.TangocardSDK, entopts map[string]any) *RewardReasonsMapEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RewardReasonsMapEntity) GetName() string { return e.name }
...
func (e *RewardReasonsMapEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RewardReasonsMapEntity) Deleted() bool {
	return e.deleted
}


func (e *RewardReasonsMapEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRewardReasonsMapEntity(e.client, opts)
}

func (e *RewardReasonsMapEntity) Data(args ...any) any {
...
func (e *RewardReasonsMapEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RewardReasonsMap; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RewardReasonsMapEntity) DataTyped(data ...RewardReasonsMap) RewardReasonsMap {
	if len(data) > 0 {
		return typedFrom[RewardReasonsMap](e.Data(asMap(data[0])))
	}
	return typedFrom[RewardReasonsMap](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RewardReasonsMap (all fields
// optional at the wire level).
func (e *RewardReasonsMapEntity) MatchTyped(match ...RewardReasonsMap) RewardReasonsMap {
	if len(match) > 0 {
		return typedFrom[RewardReasonsMap](e.Match(asMap(match[0])))
	}
	return typedFrom[RewardReasonsMap](e.Match())
}
...
func (e *RewardReasonsMapEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RewardReasonsMapEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RewardReasonsMapLoadMatch and returns an RewardReasonsMap. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RewardReasonsMapEntity) LoadTyped(reqmatch RewardReasonsMapLoadMatch, ctrl map[string]any) (RewardReasonsMap, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RewardReasonsMap{}, err
	}
	return typedFrom[RewardReasonsMap](res), nil
}



func (e *RewardReasonsMapEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RewardReasonsMapEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RewardReasonsMapEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RewardReasonsMapEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RewardReasonsMapEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
