...
type PrepaidCardInfoEntity struct {
	name    string
...
func NewPrepaidCardInfoEntity(client *core.TangocardSDK, entopts map[string]any) *PrepaidCardInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PrepaidCardInfoEntity) GetName() string { return e.name }
...
func (e *PrepaidCardInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PrepaidCardInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *PrepaidCardInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPrepaidCardInfoEntity(e.client, opts)
}

func (e *PrepaidCardInfoEntity) Data(args ...any) any {
...
func (e *PrepaidCardInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PrepaidCardInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PrepaidCardInfoEntity) DataTyped(data ...PrepaidCardInfo) PrepaidCardInfo {
	if len(data) > 0 {
		return typedFrom[PrepaidCardInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[PrepaidCardInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PrepaidCardInfo (all fields
// optional at the wire level).
func (e *PrepaidCardInfoEntity) MatchTyped(match ...PrepaidCardInfo) PrepaidCardInfo {
	if len(match) > 0 {
		return typedFrom[PrepaidCardInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[PrepaidCardInfo](e.Match())
}
...
func (e *PrepaidCardInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PrepaidCardInfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PrepaidCardInfoLoadMatch and returns an PrepaidCardInfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PrepaidCardInfoEntity) LoadTyped(reqmatch PrepaidCardInfoLoadMatch, ctrl map[string]any) (PrepaidCardInfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PrepaidCardInfo{}, err
	}
	return typedFrom[PrepaidCardInfo](res), nil
}



func (e *PrepaidCardInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PrepaidCardInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PrepaidCardInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PrepaidCardInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PrepaidCardInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
