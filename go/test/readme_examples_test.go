...
const testSeed = `map[string]any{"entity": map[string]any{"catalog": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "customer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "order": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
