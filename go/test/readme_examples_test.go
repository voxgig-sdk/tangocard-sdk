...
const testSeed = `map[string]any{"entity": map[string]any{"account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "add_comment_escalation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "all_event_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "async_order": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "async_order_detail_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "async_order_line_items_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "async_reason_codes_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "async_update_line_item_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "balance_alert_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "brand_categories_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "catalog": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "choice_product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country_view_summary": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "create_account_criterion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "create_customer_criterion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "credential_type_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "credit_card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "credit_card_deposit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "credit_card_unregister": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "customer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_template_list_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_template_view_verbose": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "embeddable_response_dto": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "exchange_rates_with_disclaimer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "line_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "low_balance_alert_list_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "low_balance_alert_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mobile_country": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "n14_webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "n1_customer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "n2_account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "n3_fund": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "n8_line_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "n9_digital_template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "order": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "order_view_summary": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "prepaid_card_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "prepaid_card_transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reissue_card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "replacement_reason": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "resend": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reward_reasons_map": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transfer_fund": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update_account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update_webhook_subscription_response_view": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
