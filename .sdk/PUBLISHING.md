...
|---|---|---|
| `js/` | @voxgig-sdk/tangocard-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/tangocard | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/tangocard-js \
      --repository voxgig-sdk/tangocard-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/tangocard-js` shows it, and
`npm trust revoke @voxgig-sdk/tangocard-js --id=<id>` removes it.
