...
// Tangocard SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TangocardMakeRequest
{
    public static function call(TangocardContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TangocardResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TangocardResponse($fetched);
        } else {
