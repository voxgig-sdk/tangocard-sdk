...
class TangocardPagingFeature extends TangocardBaseFeature
{
    ...
    private function _graphql_pre_request(TangocardContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(TangocardContext $ctx): bool
    {
