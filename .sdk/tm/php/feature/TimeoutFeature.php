...
class TangocardTimeoutFeature extends TangocardBaseFeature
{
    ...
    private function _with_timeout(TangocardContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TangocardContext $_ctx, float $ms): void
    {
        $client = $this->client;
