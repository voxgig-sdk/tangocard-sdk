...
from projectname_sdk import TangocardSDK
from projectname_sdk.core.spec import TangocardSpec
from projectname_sdk.core.result import TangocardResult
from projectname_sdk.core.response import TangocardResponse
from projectname_sdk.core.operation import TangocardOperation
from projectname_sdk.core.error import TangocardError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TangocardBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return TangocardError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = TangocardSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = TangocardSDK.test(None, None)
        ...
        class TestInitFeature(TangocardBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TangocardBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TangocardSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TangocardSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TangocardSDK.test(None, setup_opts)
