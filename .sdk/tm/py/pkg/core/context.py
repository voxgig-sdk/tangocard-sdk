...
from projectname_sdk.core.control import TangocardControl
...
class TangocardContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, TangocardSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TangocardResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TangocardResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TangocardError(code, msg, self)
