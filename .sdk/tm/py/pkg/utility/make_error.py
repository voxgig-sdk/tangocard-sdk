# Tangocard SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, TangocardError):
        errmsg = err.msg
    ...
    msg = "TangocardSDK: " + opname + ": " + errmsg
    ...
    sdk_err = TangocardError("", msg, ctx)
