...
describe('AsyncOrderDetailViewEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['update', 'load']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'async_order_detail_view.' + op, live)) return
    }
    ...
    let async_order_detail_view_ref01_data = Object.values(setup.data.existing.async_order_detail_view)[0] as any

    // UPDATE
    const async_order_detail_view_ref01_ent = client.AsyncOrderDetailView()
    const async_order_detail_view_ref01_data_up0: any = {}
    ...
    ;(async_order_detail_view_ref01_data_up0 as any)[async_order_detail_view_ref01_markdef_up0.name] = async_order_detail_view_ref01_markdef_up0.value
    ...
    assert((async_order_detail_view_ref01_resdata_up0 as any)[async_order_detail_view_ref01_markdef_up0.name] === async_order_detail_view_ref01_markdef_up0.value)


    // LOAD
    const async_order_detail_view_ref01_match_dt0: any = {}
