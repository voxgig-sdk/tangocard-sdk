...
import type {
  BalanceAlertView,
  BalanceAlertViewRemoveMatch,
} from '../TangocardTypes'

// TODO: needs Entity superclass
class BalanceAlertViewEntity extends TangocardEntityBase<BalanceAlertView> {

  constructor(client: TangocardSDK, entopts: any) {
    super(client, entopts)
    this.name = 'balance_alert_view'
    this.name_ = 'balance_alert_view'
    this.Name = 'BalanceAlertView'
  }


  make(this: BalanceAlertViewEntity) {
    return new BalanceAlertViewEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: BalanceAlertViewRemoveMatch, ctrl?: Control,
  ): Promise<BalanceAlertViewEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<BalanceAlertViewEntity> return stays clean under strict null checks.
