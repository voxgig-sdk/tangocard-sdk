...
import type {
  N9DigitalTemplate,
  N9DigitalTemplateRemoveMatch,
} from '../TangocardTypes'

// TODO: needs Entity superclass
class N9DigitalTemplateEntity extends TangocardEntityBase<N9DigitalTemplate> {

  constructor(client: TangocardSDK, entopts: any) {
    super(client, entopts)
    this.name = 'n9_digital_template'
    this.name_ = 'n9_digital_template'
    this.Name = 'N9DigitalTemplate'
  }


  make(this: N9DigitalTemplateEntity) {
    return new N9DigitalTemplateEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: N9DigitalTemplateRemoveMatch, ctrl?: Control,
  ): Promise<N9DigitalTemplateEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<N9DigitalTemplateEntity> return stays clean under strict null checks.
