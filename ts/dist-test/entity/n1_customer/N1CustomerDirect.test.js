...
(0, node_test_1.describe)('N1CustomerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-n1_customer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-n1_customer', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["customer_identifier01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_N1_CUSTOMER_ENTID'];
...
//# sourceMappingURL=N1CustomerDirect.test.js.map