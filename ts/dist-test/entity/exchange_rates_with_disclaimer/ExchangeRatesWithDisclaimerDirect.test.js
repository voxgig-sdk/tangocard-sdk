...
(0, node_test_1.describe)('ExchangeRatesWithDisclaimerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-exchange_rates_with_disclaimer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-exchange_rates_with_disclaimer', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_EXCHANGE_RATES_WITH_DISCLAIMER_ENTID'];
...
//# sourceMappingURL=ExchangeRatesWithDisclaimerDirect.test.js.map