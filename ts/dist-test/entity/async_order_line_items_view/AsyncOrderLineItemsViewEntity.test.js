...
function basicSetup(extra) {
    ...
    let idmap = transform(['async_order_line_items_view01', 'async_order_line_items_view02', 'async_order_line_items_view03', 'customer01', 'customer02', 'customer03', 'account01', 'account02', 'account03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
