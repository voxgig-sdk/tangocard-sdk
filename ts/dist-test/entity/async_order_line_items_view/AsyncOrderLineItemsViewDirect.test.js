...
(0, node_test_1.describe)('AsyncOrderLineItemsViewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-async_order_line_items_view', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-async_order_line_items_view', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["account01", "customer01", "external_ref01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_ASYNC_ORDER_LINE_ITEMS_VIEW_ENTID'];
...
//# sourceMappingURL=AsyncOrderLineItemsViewDirect.test.js.map