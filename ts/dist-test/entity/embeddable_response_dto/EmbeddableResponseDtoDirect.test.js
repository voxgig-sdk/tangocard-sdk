...
(0, node_test_1.describe)('EmbeddableResponseDtoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-embeddable_response_dto', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-embeddable_response_dto', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["reference_line_item_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_EMBEDDABLE_RESPONSE_DTO_ENTID'];
...
//# sourceMappingURL=EmbeddableResponseDtoDirect.test.js.map