...
(0, node_test_1.describe)('EmbeddableResponseDtoEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/embeddable_response_dto/EmbeddableResponseDtoTestData.json');
    ...
    let idmap = transform(['embeddable_response_dto01', 'embeddable_response_dto02', 'embeddable_response_dto03', 'line_item01', 'line_item02', 'line_item03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EmbeddableResponseDtoEntity.test.js.map