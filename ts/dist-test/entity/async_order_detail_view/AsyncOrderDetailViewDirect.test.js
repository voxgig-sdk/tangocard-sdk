...
(0, node_test_1.describe)('AsyncOrderDetailViewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-async_order_detail_view', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-async_order_detail_view', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["account_identifier01", "customer_identifier01", "external_ref_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_ASYNC_ORDER_DETAIL_VIEW_ENTID'];
...
//# sourceMappingURL=AsyncOrderDetailViewDirect.test.js.map