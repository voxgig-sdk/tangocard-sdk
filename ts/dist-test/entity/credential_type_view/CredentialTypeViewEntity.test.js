...
(0, node_test_1.describe)('CredentialTypeViewEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/credential_type_view/CredentialTypeViewTestData.json');
    ...
    let idmap = transform(['credential_type_view01', 'credential_type_view02', 'credential_type_view03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CredentialTypeViewEntity.test.js.map