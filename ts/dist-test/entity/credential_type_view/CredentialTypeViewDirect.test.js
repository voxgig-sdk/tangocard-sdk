...
(0, node_test_1.describe)('CredentialTypeViewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-credential_type_view', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-credential_type_view', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_CREDENTIAL_TYPE_VIEW_ENTID'];
...
//# sourceMappingURL=CredentialTypeViewDirect.test.js.map