...
(0, node_test_1.describe)('AsyncOrderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-async_order', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-async_order', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_ASYNC_ORDER_ENTID'];
...
//# sourceMappingURL=AsyncOrderDirect.test.js.map