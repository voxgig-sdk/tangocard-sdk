...
(0, node_test_1.describe)('EmailTemplateViewVerboseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-email_template_view_verbose', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-email_template_view_verbose', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["etid01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-email_template_view_verbose', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-email_template_view_verbose', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_EMAIL_TEMPLATE_VIEW_VERBOSE_ENTID'];
...
//# sourceMappingURL=EmailTemplateViewVerboseDirect.test.js.map