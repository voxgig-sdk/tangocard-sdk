...
function basicSetup(extra) {
    ...
    let idmap = transform(['balance_alert_view01', 'balance_alert_view02', 'balance_alert_view03', 'customer01', 'customer02', 'customer03', 'account01', 'account02', 'account03', 'lowbalance01', 'lowbalance02', 'lowbalance03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
