...
(0, node_test_1.describe)('CountryViewSummaryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != country_view_summary_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/country_view_summary/CountryViewSummaryTestData.json');
    ...
    let idmap = transform(['country_view_summary01', 'country_view_summary02', 'country_view_summary03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CountryViewSummaryEntity.test.js.map