...
(0, node_test_1.describe)('CountryViewSummaryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-country_view_summary', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-country_view_summary', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_COUNTRY_VIEW_SUMMARY_ENTID'];
...
//# sourceMappingURL=CountryViewSummaryDirect.test.js.map