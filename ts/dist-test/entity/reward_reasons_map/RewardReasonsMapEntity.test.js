...
(0, node_test_1.describe)('RewardReasonsMapEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/reward_reasons_map/RewardReasonsMapTestData.json');
    ...
    let idmap = transform(['reward_reasons_map01', 'reward_reasons_map02', 'reward_reasons_map03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=RewardReasonsMapEntity.test.js.map