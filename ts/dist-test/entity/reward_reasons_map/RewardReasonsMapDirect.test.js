...
(0, node_test_1.describe)('RewardReasonsMapDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-reward_reasons_map', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-reward_reasons_map', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_REWARD_REASONS_MAP_ENTID'];
...
//# sourceMappingURL=RewardReasonsMapDirect.test.js.map