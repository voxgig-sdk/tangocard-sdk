...
(0, node_test_1.describe)('AddCommentEscalationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != add_comment_escalation_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/add_comment_escalation/AddCommentEscalationTestData.json');
    ...
    let idmap = transform(['add_comment_escalation01', 'add_comment_escalation02', 'add_comment_escalation03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AddCommentEscalationEntity.test.js.map