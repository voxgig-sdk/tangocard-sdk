...
(0, node_test_1.describe)('ReplacementReasonEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/replacement_reason/ReplacementReasonTestData.json');
    ...
    let idmap = transform(['replacement_reason01', 'replacement_reason02', 'replacement_reason03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ReplacementReasonEntity.test.js.map