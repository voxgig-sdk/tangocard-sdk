...
(0, node_test_1.describe)('ReplacementReasonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-replacement_reason', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-replacement_reason', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'TANGOCARD_TEST_REPLACEMENT_REASON_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_REPLACEMENT_REASON_ENTID'];
...
//# sourceMappingURL=ReplacementReasonDirect.test.js.map