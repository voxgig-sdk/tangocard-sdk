...
(0, node_test_1.describe)('LowBalanceAlertListViewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TangocardSDK({
    ...
    (0, node_test_1.test)('direct-list-low_balance_alert_list_view', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-low_balance_alert_list_view', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["account_identifier01", "customer_identifier01"]))
            return;
...
function liveScenariosActive() { return false && process.env.TANGOCARD_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TangocardSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.TANGOCARD_APIKEY,
            secret: env.TANGOCARD_SECRET,
        }));
        let idmap = env['TANGOCARD_TEST_LOW_BALANCE_ALERT_LIST_VIEW_ENTID'];
    ...
    const client = new __1.TangocardSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LowBalanceAlertListViewDirect.test.js.map