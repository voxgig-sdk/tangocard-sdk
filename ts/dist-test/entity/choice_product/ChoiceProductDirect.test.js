...
(0, node_test_1.describe)('ChoiceProductDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-choice_product', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-choice_product', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-choice_product', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-choice_product', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_CHOICE_PRODUCT_ENTID'];
...
//# sourceMappingURL=ChoiceProductDirect.test.js.map