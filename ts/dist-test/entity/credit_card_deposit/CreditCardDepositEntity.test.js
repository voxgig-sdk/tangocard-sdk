...
(0, node_test_1.describe)('CreditCardDepositEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'credit_card_deposit.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != credit_card_deposit_ref01_data.id);
        // LOAD
        ...
        (0, node_assert_1.default)(credit_card_deposit_ref01_data_dt0.id === credit_card_deposit_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/credit_card_deposit/CreditCardDepositTestData.json');
    ...
    let idmap = transform(['credit_card_deposit01', 'credit_card_deposit02', 'credit_card_deposit03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CreditCardDepositEntity.test.js.map