...
(0, node_test_1.describe)('OrderViewSummaryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'order_view_summary.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != order_view_summary_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/order_view_summary/OrderViewSummaryTestData.json');
    ...
    let idmap = transform(['order_view_summary01', 'order_view_summary02', 'order_view_summary03', 'line_item01', 'line_item02', 'line_item03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OrderViewSummaryEntity.test.js.map