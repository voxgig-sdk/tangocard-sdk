...
(0, node_test_1.describe)('PrepaidCardTransactionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-prepaid_card_transaction', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-prepaid_card_transaction', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_PREPAID_CARD_TRANSACTION_ENTID'];
...
//# sourceMappingURL=PrepaidCardTransactionDirect.test.js.map