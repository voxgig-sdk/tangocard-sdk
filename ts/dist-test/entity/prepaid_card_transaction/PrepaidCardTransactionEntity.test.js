...
function basicSetup(extra) {
    ...
    let idmap = transform(['prepaid_card_transaction01', 'prepaid_card_transaction02', 'prepaid_card_transaction03', 'get_card_transaction01', 'get_card_transaction02', 'get_card_transaction03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
