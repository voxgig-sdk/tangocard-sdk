...
(0, node_test_1.describe)('AsyncReasonCodesViewEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'async_reason_codes_view.' + op, live))
                return;
        }
        ...
        let async_reason_codes_view_ref01_data = Object.values(setup.data.existing.async_reason_codes_view)[0];
        // LOAD
        const async_reason_codes_view_ref01_ent = client.AsyncReasonCodesView();
        const async_reason_codes_view_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != async_reason_codes_view_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/async_reason_codes_view/AsyncReasonCodesViewTestData.json');
    ...
    let idmap = transform(['async_reason_codes_view01', 'async_reason_codes_view02', 'async_reason_codes_view03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AsyncReasonCodesViewEntity.test.js.map