...
(0, node_test_1.describe)('ReissueCardEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != reissue_card_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/reissue_card/ReissueCardTestData.json');
    ...
    let idmap = transform(['reissue_card01', 'reissue_card02', 'reissue_card03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ReissueCardEntity.test.js.map