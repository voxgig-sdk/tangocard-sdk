...
(0, node_test_1.describe)('AllEventTypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-all_event_type', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-all_event_type', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_ALL_EVENT_TYPE_ENTID'];
...
//# sourceMappingURL=AllEventTypeDirect.test.js.map