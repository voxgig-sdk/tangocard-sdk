...
(0, node_test_1.describe)('LineItemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-line_item', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-line_item', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-line_item', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-line_item', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TANGOCARD_TEST_LINE_ITEM_ENTID'];
...
//# sourceMappingURL=LineItemDirect.test.js.map