...
const TEST_SEED = { "entity": { "account": { "test01": { "id": "test01" } }, "add_comment_escalation": { "test01": { "id": "test01" } }, "all_event_type": { "test01": { "id": "test01" } }, "async_order": { "test01": { "id": "test01" } }, "async_order_detail_view": { "test01": { "id": "test01" } }, "async_order_line_items_view": { "test01": { "id": "test01" } }, "async_reason_codes_view": { "test01": { "id": "test01" } }, "async_update_line_item_view": { "test01": { "id": "test01" } }, "balance_alert_view": { "test01": { "id": "test01" } }, "brand_categories_view": { "test01": { "id": "test01" } }, "catalog": { "test01": { "id": "test01" } }, "choice_product": { "test01": { "id": "test01" } }, "country_view_summary": { "test01": { "id": "test01" } }, "create_account_criterion": { "test01": { "id": "test01" } }, "create_customer_criterion": { "test01": { "id": "test01" } }, "credential_type_view": { "test01": { "id": "test01" } }, "credit_card": { "test01": { "id": "test01" } }, "credit_card_deposit": { "test01": { "id": "test01" } }, "credit_card_unregister": { "test01": { "id": "test01" } }, "customer": { "test01": { "id": "test01" } }, "email_template_list_view": { "test01": { "id": "test01" } }, "email_template_view_verbose": { "test01": { "id": "test01" } }, "embeddable_response_dto": { "test01": { "id": "test01" } }, "exchange_rates_with_disclaimer": { "test01": { "id": "test01" } }, "line_item": { "test01": { "id": "test01" } }, "low_balance_alert_list_view": { "test01": { "id": "test01" } }, "low_balance_alert_view": { "test01": { "id": "test01" } }, "mobile_country": { "test01": { "id": "test01" } }, "n14_webhook": { "test01": { "id": "test01" } }, "n1_customer": { "test01": { "id": "test01" } }, "n2_account": { "test01": { "id": "test01" } }, "n3_fund": { "test01": { "id": "test01" } }, "n8_line_item": { "test01": { "id": "test01" } }, "n9_digital_template": { "test01": { "id": "test01" } }, "order": { "test01": { "id": "test01" } }, "order_view_summary": { "test01": { "id": "test01" } }, "prepaid_card_info": { "test01": { "id": "test01" } }, "prepaid_card_transaction": { "test01": { "id": "test01" } }, "reissue_card": { "test01": { "id": "test01" } }, "replacement_reason": { "test01": { "id": "test01" } }, "resend": { "test01": { "id": "test01" } }, "reward_reasons_map": { "test01": { "id": "test01" } }, "transfer_fund": { "test01": { "id": "test01" } }, "update_account": { "test01": { "id": "test01" } }, "update_webhook_subscription_response_view": { "test01": { "id": "test01" } }, "webhook": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+TangocardSDK\b/.test(code) ||
        /\bTangocardSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+TangocardSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/TangocardSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
