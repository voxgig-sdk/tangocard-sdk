...
function envOverride(m) {
    if ('TRUE' === process.env.TANGOCARD_TEST_LIVE ||
        'TRUE' === process.env.TANGOCARD_TEST_OVERRIDE) {
    ...
    m.TANGOCARD_TEST_EXPLAIN = process.env.TANGOCARD_TEST_EXPLAIN || m.TANGOCARD_TEST_EXPLAIN;
    return m;
}
