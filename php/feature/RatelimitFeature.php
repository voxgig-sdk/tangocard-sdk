...
// Tangocard SDK ratelimit feature
...
class TangocardRatelimitFeature extends TangocardBaseFeature
{
    ...
    private function _acquire(TangocardContext $ctx): void
    {
    ...
    private function _track(TangocardContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
