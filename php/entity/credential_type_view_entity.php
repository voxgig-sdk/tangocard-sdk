...
// Tangocard SDK CredentialTypeView entity
...
class CredentialTypeViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "credential_type_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CredentialTypeViewEntity($this->_client, $opts);
    }

    /**
     * @param CredentialTypeView|array $args CredentialTypeView data (assoc-array) to store.
     */
    ...
    /**
     * @return CredentialTypeView|array The current CredentialTypeView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CredentialTypeView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CredentialTypeView fields).
     */
    ...
    /**
     * List CredentialTypeView items matching the given filter.
     *
     * @param CredentialTypeViewListMatch|array|null $reqmatch Match filter (any subset
     *   of CredentialTypeView fields) as an assoc-array; CredentialTypeViewListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CredentialTypeView[]|array A list of CredentialTypeView items as assoc-arrays at
