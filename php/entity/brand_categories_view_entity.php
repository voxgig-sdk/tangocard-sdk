...
// Tangocard SDK BrandCategoriesView entity
...
class BrandCategoriesViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "brand_categories_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new BrandCategoriesViewEntity($this->_client, $opts);
    }

    /**
     * @param BrandCategoriesView|array $args BrandCategoriesView data (assoc-array) to store.
     */
    ...
    /**
     * @return BrandCategoriesView|array The current BrandCategoriesView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BrandCategoriesView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BrandCategoriesView fields).
     */
    ...
    /**
     * List BrandCategoriesView items matching the given filter.
     *
     * @param BrandCategoriesViewListMatch|array|null $reqmatch Match filter (any subset
     *   of BrandCategoriesView fields) as an assoc-array; BrandCategoriesViewListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BrandCategoriesView[]|array A list of BrandCategoriesView items as assoc-arrays at
