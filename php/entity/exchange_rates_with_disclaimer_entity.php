...
// Tangocard SDK ExchangeRatesWithDisclaimer entity
...
class ExchangeRatesWithDisclaimerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "exchange_rates_with_disclaimer";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ExchangeRatesWithDisclaimerEntity($this->_client, $opts);
    }

    /**
     * @param ExchangeRatesWithDisclaimer|array $args ExchangeRatesWithDisclaimer data (assoc-array) to store.
     */
    ...
    /**
     * @return ExchangeRatesWithDisclaimer|array The current ExchangeRatesWithDisclaimer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ExchangeRatesWithDisclaimer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ExchangeRatesWithDisclaimer fields).
     */
    ...
    /**
     * List ExchangeRatesWithDisclaimer items matching the given filter.
     *
     * @param ExchangeRatesWithDisclaimerListMatch|array|null $reqmatch Match filter (any subset
     *   of ExchangeRatesWithDisclaimer fields) as an assoc-array; ExchangeRatesWithDisclaimerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ExchangeRatesWithDisclaimer[]|array A list of ExchangeRatesWithDisclaimer items as assoc-arrays at
