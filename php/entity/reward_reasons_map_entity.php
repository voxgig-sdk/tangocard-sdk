...
// Tangocard SDK RewardReasonsMap entity
...
class RewardReasonsMapEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RewardReasonsMapEntity($this->_client, $opts);
    }

    /**
     * @param RewardReasonsMap|array $args RewardReasonsMap data (assoc-array) to store.
     */
    ...
    /**
     * @return RewardReasonsMap|array The current RewardReasonsMap data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RewardReasonsMap fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RewardReasonsMap fields).
     */
    ...
    /**
     * Load a single RewardReasonsMap.
     *
     * @param RewardReasonsMapLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RewardReasonsMapLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RewardReasonsMap|array The loaded RewardReasonsMap as an assoc-array at the
