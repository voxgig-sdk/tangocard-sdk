...
// Tangocard SDK BalanceAlertView entity
...
class BalanceAlertViewEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BalanceAlertViewEntity($this->_client, $opts);
    }

    /**
     * @param BalanceAlertView|array $args BalanceAlertView data (assoc-array) to store.
     */
    ...
    /**
     * @return BalanceAlertView|array The current BalanceAlertView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BalanceAlertView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BalanceAlertView fields).
     */
    ...
    /**
     * Remove an BalanceAlertView matching the given criteria.
     *
     * @param BalanceAlertViewRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BalanceAlertViewRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BalanceAlertView|array The removed BalanceAlertView as an assoc-array at the
