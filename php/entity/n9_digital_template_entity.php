...
// Tangocard SDK N9DigitalTemplate entity
...
class N9DigitalTemplateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "n9_digital_template";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new N9DigitalTemplateEntity($this->_client, $opts);
    }

    /**
     * @param N9DigitalTemplate|array $args N9DigitalTemplate data (assoc-array) to store.
     */
    ...
    /**
     * @return N9DigitalTemplate|array The current N9DigitalTemplate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of N9DigitalTemplate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of N9DigitalTemplate fields).
     */
    ...
    /**
     * Remove an N9DigitalTemplate matching the given criteria.
     *
     * @param N9DigitalTemplateRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; N9DigitalTemplateRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return N9DigitalTemplate|array The removed N9DigitalTemplate as an assoc-array at the
