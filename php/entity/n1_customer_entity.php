...
// Tangocard SDK N1Customer entity
...
class N1CustomerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new N1CustomerEntity($this->_client, $opts);
    }

    /**
     * @param N1Customer|array $args N1Customer data (assoc-array) to store.
     */
    ...
    /**
     * @return N1Customer|array The current N1Customer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of N1Customer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of N1Customer fields).
     */
    ...
    /**
     * Load a single N1Customer.
     *
     * @param N1CustomerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed N1CustomerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return N1Customer|array The loaded N1Customer as an assoc-array at the
