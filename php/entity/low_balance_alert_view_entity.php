...
// Tangocard SDK LowBalanceAlertView entity
...
class LowBalanceAlertViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "low_balance_alert_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new LowBalanceAlertViewEntity($this->_client, $opts);
    }

    /**
     * @param LowBalanceAlertView|array $args LowBalanceAlertView data (assoc-array) to store.
     */
    ...
    /**
     * @return LowBalanceAlertView|array The current LowBalanceAlertView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LowBalanceAlertView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LowBalanceAlertView fields).
     */
    ...
    /**
     * Load a single LowBalanceAlertView.
     *
     * @param LowBalanceAlertViewLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LowBalanceAlertViewLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LowBalanceAlertView|array The loaded LowBalanceAlertView as an assoc-array at the
    ...
    /**
     * Create a new LowBalanceAlertView.
     *
     * @param LowBalanceAlertViewCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LowBalanceAlertViewCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LowBalanceAlertView|array The created LowBalanceAlertView as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing LowBalanceAlertView.
     *
     * @param LowBalanceAlertViewUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LowBalanceAlertViewUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LowBalanceAlertView|array The updated LowBalanceAlertView as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
