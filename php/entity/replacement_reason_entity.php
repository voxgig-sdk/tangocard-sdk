...
// Tangocard SDK ReplacementReason entity
...
class ReplacementReasonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReplacementReasonEntity($this->_client, $opts);
    }

    /**
     * @param ReplacementReason|array $args ReplacementReason data (assoc-array) to store.
     */
    ...
    /**
     * @return ReplacementReason|array The current ReplacementReason data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReplacementReason fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReplacementReason fields).
     */
    ...
    /**
     * List ReplacementReason items matching the given filter.
     *
     * @param ReplacementReasonListMatch|array|null $reqmatch Match filter (any subset
     *   of ReplacementReason fields) as an assoc-array; ReplacementReasonListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReplacementReason[]|array A list of ReplacementReason items as assoc-arrays at
