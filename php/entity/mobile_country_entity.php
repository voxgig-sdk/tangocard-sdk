...
// Tangocard SDK MobileCountry entity
...
class MobileCountryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MobileCountryEntity($this->_client, $opts);
    }

    /**
     * @param MobileCountry|array $args MobileCountry data (assoc-array) to store.
     */
    ...
    /**
     * @return MobileCountry|array The current MobileCountry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MobileCountry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MobileCountry fields).
     */
    ...
    /**
     * Load a single MobileCountry.
     *
     * @param MobileCountryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MobileCountryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MobileCountry|array The loaded MobileCountry as an assoc-array at the
