...
class LineItemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LineItemEntity($this->_client, $opts);
    }

    /**
     * @param LineItem|array $args LineItem data (assoc-array) to store.
     */
    ...
    /**
     * @return LineItem|array The current LineItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LineItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LineItem fields).
     */
    ...
    /**
     * Load a single LineItem.
     *
     * @param LineItemLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LineItemLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LineItem|array The loaded LineItem as an assoc-array at the
    ...
    /**
     * List LineItem items matching the given filter.
     *
     * @param LineItemListMatch|array|null $reqmatch Match filter (any subset
     *   of LineItem fields) as an assoc-array; LineItemListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LineItem[]|array A list of LineItem items as assoc-arrays at
     ...
     *
     * @param LineItemCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LineItemCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LineItem|array The created LineItem as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
