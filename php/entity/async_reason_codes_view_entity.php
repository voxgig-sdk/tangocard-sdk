...
// Tangocard SDK AsyncReasonCodesView entity
...
class AsyncReasonCodesViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "async_reason_codes_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AsyncReasonCodesViewEntity($this->_client, $opts);
    }

    /**
     * @param AsyncReasonCodesView|array $args AsyncReasonCodesView data (assoc-array) to store.
     */
    ...
    /**
     * @return AsyncReasonCodesView|array The current AsyncReasonCodesView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AsyncReasonCodesView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AsyncReasonCodesView fields).
     */
    ...
    /**
     * Load a single AsyncReasonCodesView.
     *
     * @param AsyncReasonCodesViewLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AsyncReasonCodesViewLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AsyncReasonCodesView|array The loaded AsyncReasonCodesView as an assoc-array at the
