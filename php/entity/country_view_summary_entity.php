...
// Tangocard SDK CountryViewSummary entity
...
class CountryViewSummaryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "country_view_summary";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CountryViewSummaryEntity($this->_client, $opts);
    }

    /**
     * @param CountryViewSummary|array $args CountryViewSummary data (assoc-array) to store.
     */
    ...
    /**
     * @return CountryViewSummary|array The current CountryViewSummary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CountryViewSummary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CountryViewSummary fields).
     */
    ...
    /**
     * Load a single CountryViewSummary.
     *
     * @param CountryViewSummaryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CountryViewSummaryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CountryViewSummary|array The loaded CountryViewSummary as an assoc-array at the
