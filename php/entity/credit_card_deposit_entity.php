...
// Tangocard SDK CreditCardDeposit entity
...
class CreditCardDepositEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "credit_card_deposit";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CreditCardDepositEntity($this->_client, $opts);
    }

    /**
     * @param CreditCardDeposit|array $args CreditCardDeposit data (assoc-array) to store.
     */
    ...
    /**
     * @return CreditCardDeposit|array The current CreditCardDeposit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreditCardDeposit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreditCardDeposit fields).
     */
    ...
    /**
     * Load a single CreditCardDeposit.
     *
     * @param CreditCardDepositLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CreditCardDepositLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreditCardDeposit|array The loaded CreditCardDeposit as an assoc-array at the
    ...
    /**
     * Create a new CreditCardDeposit.
     *
     * @param CreditCardDepositCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreditCardDepositCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreditCardDeposit|array The created CreditCardDeposit as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
