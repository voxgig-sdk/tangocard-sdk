...
// Tangocard SDK AsyncOrderDetailView entity
...
class AsyncOrderDetailViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "async_order_detail_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AsyncOrderDetailViewEntity($this->_client, $opts);
    }

    /**
     * @param AsyncOrderDetailView|array $args AsyncOrderDetailView data (assoc-array) to store.
     */
    ...
    /**
     * @return AsyncOrderDetailView|array The current AsyncOrderDetailView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AsyncOrderDetailView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AsyncOrderDetailView fields).
     */
    ...
    /**
     * Load a single AsyncOrderDetailView.
     *
     * @param AsyncOrderDetailViewLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AsyncOrderDetailViewLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AsyncOrderDetailView|array The loaded AsyncOrderDetailView as an assoc-array at the
    ...
    /**
     * Update an existing AsyncOrderDetailView.
     *
     * @param AsyncOrderDetailViewUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AsyncOrderDetailViewUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AsyncOrderDetailView|array The updated AsyncOrderDetailView as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
