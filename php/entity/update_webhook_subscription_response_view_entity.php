...
class UpdateWebhookSubscriptionResponseViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "update_webhook_subscription_response_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UpdateWebhookSubscriptionResponseViewEntity($this->_client, $opts);
    }

    /**
     * @param UpdateWebhookSubscriptionResponseView|array $args UpdateWebhookSubscriptionResponseView data (assoc-array) to store.
     */
    ...
    /**
     * @return UpdateWebhookSubscriptionResponseView|array The current UpdateWebhookSubscriptionResponseView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UpdateWebhookSubscriptionResponseView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UpdateWebhookSubscriptionResponseView fields).
     */
    ...
    /**
     * Update an existing UpdateWebhookSubscriptionResponseView.
     *
     * @param UpdateWebhookSubscriptionResponseViewUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UpdateWebhookSubscriptionResponseViewUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UpdateWebhookSubscriptionResponseView|array The updated UpdateWebhookSubscriptionResponseView as an assoc-array at the
