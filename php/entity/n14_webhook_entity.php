...
// Tangocard SDK N14Webhook entity
...
class N14WebhookEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new N14WebhookEntity($this->_client, $opts);
    }

    /**
     * @param N14Webhook|array $args N14Webhook data (assoc-array) to store.
     */
    ...
    /**
     * @return N14Webhook|array The current N14Webhook data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of N14Webhook fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of N14Webhook fields).
     */
    ...
    /**
     * Load a single N14Webhook.
     *
     * @param N14WebhookLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed N14WebhookLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return N14Webhook|array The loaded N14Webhook as an assoc-array at the
    ...
    /**
     * List N14Webhook items matching the given filter.
     *
     * @param N14WebhookListMatch|array|null $reqmatch Match filter (any subset
     *   of N14Webhook fields) as an assoc-array; N14WebhookListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return N14Webhook[]|array A list of N14Webhook items as assoc-arrays at
    ...
    /**
     * Create a new N14Webhook.
     *
     * @param N14WebhookCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed N14WebhookCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return N14Webhook|array The created N14Webhook as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an N14Webhook matching the given criteria.
     *
     * @param N14WebhookRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; N14WebhookRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return N14Webhook|array The removed N14Webhook as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
