...
// Tangocard SDK ChoiceProduct entity
...
class ChoiceProductEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ChoiceProductEntity($this->_client, $opts);
    }

    /**
     * @param ChoiceProduct|array $args ChoiceProduct data (assoc-array) to store.
     */
    ...
    /**
     * @return ChoiceProduct|array The current ChoiceProduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ChoiceProduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ChoiceProduct fields).
     */
    ...
    /**
     * Load a single ChoiceProduct.
     *
     * @param ChoiceProductLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ChoiceProductLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ChoiceProduct|array The loaded ChoiceProduct as an assoc-array at the
    ...
    /**
     * List ChoiceProduct items matching the given filter.
     *
     * @param ChoiceProductListMatch|array|null $reqmatch Match filter (any subset
     *   of ChoiceProduct fields) as an assoc-array; ChoiceProductListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ChoiceProduct[]|array A list of ChoiceProduct items as assoc-arrays at
