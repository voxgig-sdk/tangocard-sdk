...
// Tangocard SDK PrepaidCardInfo entity
...
class PrepaidCardInfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PrepaidCardInfoEntity($this->_client, $opts);
    }

    /**
     * @param PrepaidCardInfo|array $args PrepaidCardInfo data (assoc-array) to store.
     */
    ...
    /**
     * @return PrepaidCardInfo|array The current PrepaidCardInfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PrepaidCardInfo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PrepaidCardInfo fields).
     */
    ...
    /**
     * Load a single PrepaidCardInfo.
     *
     * @param PrepaidCardInfoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PrepaidCardInfoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrepaidCardInfo|array The loaded PrepaidCardInfo as an assoc-array at the
