...
// Tangocard SDK OrderViewSummary entity
...
class OrderViewSummaryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OrderViewSummaryEntity($this->_client, $opts);
    }

    /**
     * @param OrderViewSummary|array $args OrderViewSummary data (assoc-array) to store.
     */
    ...
    /**
     * @return OrderViewSummary|array The current OrderViewSummary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrderViewSummary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrderViewSummary fields).
     */
    ...
    /**
     * Create a new OrderViewSummary.
     *
     * @param OrderViewSummaryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrderViewSummaryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrderViewSummary|array The created OrderViewSummary as an assoc-array at the
