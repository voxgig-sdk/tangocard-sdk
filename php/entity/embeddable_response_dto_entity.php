...
// Tangocard SDK EmbeddableResponseDto entity
...
class EmbeddableResponseDtoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "embeddable_response_dto";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmbeddableResponseDtoEntity($this->_client, $opts);
    }

    /**
     * @param EmbeddableResponseDto|array $args EmbeddableResponseDto data (assoc-array) to store.
     */
    ...
    /**
     * @return EmbeddableResponseDto|array The current EmbeddableResponseDto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmbeddableResponseDto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmbeddableResponseDto fields).
     */
    ...
    /**
     * Load a single EmbeddableResponseDto.
     *
     * @param EmbeddableResponseDtoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmbeddableResponseDtoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmbeddableResponseDto|array The loaded EmbeddableResponseDto as an assoc-array at the
