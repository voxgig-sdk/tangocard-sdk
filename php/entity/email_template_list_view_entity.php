...
class EmailTemplateListViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "email_template_list_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmailTemplateListViewEntity($this->_client, $opts);
    }

    /**
     * @param EmailTemplateListView|array $args EmailTemplateListView data (assoc-array) to store.
     */
    ...
    /**
     * @return EmailTemplateListView|array The current EmailTemplateListView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailTemplateListView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmailTemplateListView fields).
     */
