...
// Tangocard SDK UpdateAccount entity
...
class UpdateAccountEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UpdateAccountEntity($this->_client, $opts);
    }

    /**
     * @param UpdateAccount|array $args UpdateAccount data (assoc-array) to store.
     */
    ...
    /**
     * @return UpdateAccount|array The current UpdateAccount data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UpdateAccount fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UpdateAccount fields).
     */
    ...
    /**
     * Create a new UpdateAccount.
     *
     * @param UpdateAccountCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UpdateAccountCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UpdateAccount|array The created UpdateAccount as an assoc-array at the
