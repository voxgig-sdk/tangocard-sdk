...
// Tangocard SDK AddCommentEscalation entity
...
class AddCommentEscalationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "add_comment_escalation";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AddCommentEscalationEntity($this->_client, $opts);
    }

    /**
     * @param AddCommentEscalation|array $args AddCommentEscalation data (assoc-array) to store.
     */
    ...
    /**
     * @return AddCommentEscalation|array The current AddCommentEscalation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AddCommentEscalation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AddCommentEscalation fields).
     */
    ...
    /**
     * Create a new AddCommentEscalation.
     *
     * @param AddCommentEscalationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AddCommentEscalationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AddCommentEscalation|array The created AddCommentEscalation as an assoc-array at the
