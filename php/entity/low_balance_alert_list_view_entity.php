...
class LowBalanceAlertListViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "low_balance_alert_list_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new LowBalanceAlertListViewEntity($this->_client, $opts);
    }

    /**
     * @param LowBalanceAlertListView|array $args LowBalanceAlertListView data (assoc-array) to store.
     */
    ...
    /**
     * @return LowBalanceAlertListView|array The current LowBalanceAlertListView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LowBalanceAlertListView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LowBalanceAlertListView fields).
     */
    ...
    /**
     * List LowBalanceAlertListView items matching the given filter.
     *
     * @param LowBalanceAlertListViewListMatch|array|null $reqmatch Match filter (any subset
     *   of LowBalanceAlertListView fields) as an assoc-array; LowBalanceAlertListViewListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LowBalanceAlertListView[]|array A list of LowBalanceAlertListView items as assoc-arrays at
