...
class AsyncUpdateLineItemViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "async_update_line_item_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AsyncUpdateLineItemViewEntity($this->_client, $opts);
    }

    /**
     * @param AsyncUpdateLineItemView|array $args AsyncUpdateLineItemView data (assoc-array) to store.
     */
    ...
    /**
     * @return AsyncUpdateLineItemView|array The current AsyncUpdateLineItemView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AsyncUpdateLineItemView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AsyncUpdateLineItemView fields).
     */
    ...
    /**
     * Update an existing AsyncUpdateLineItemView.
     *
     * @param AsyncUpdateLineItemViewUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AsyncUpdateLineItemViewUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AsyncUpdateLineItemView|array The updated AsyncUpdateLineItemView as an assoc-array at the
