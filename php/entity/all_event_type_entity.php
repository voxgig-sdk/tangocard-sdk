...
// Tangocard SDK AllEventType entity
...
class AllEventTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AllEventTypeEntity($this->_client, $opts);
    }

    /**
     * @param AllEventType|array $args AllEventType data (assoc-array) to store.
     */
    ...
    /**
     * @return AllEventType|array The current AllEventType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AllEventType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AllEventType fields).
     */
    ...
    /**
     * List AllEventType items matching the given filter.
     *
     * @param AllEventTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of AllEventType fields) as an assoc-array; AllEventTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AllEventType[]|array A list of AllEventType items as assoc-arrays at
