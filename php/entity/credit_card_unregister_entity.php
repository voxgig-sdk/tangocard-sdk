...
// Tangocard SDK CreditCardUnregister entity
...
class CreditCardUnregisterEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "credit_card_unregister";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CreditCardUnregisterEntity($this->_client, $opts);
    }

    /**
     * @param CreditCardUnregister|array $args CreditCardUnregister data (assoc-array) to store.
     */
    ...
    /**
     * @return CreditCardUnregister|array The current CreditCardUnregister data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreditCardUnregister fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreditCardUnregister fields).
     */
    ...
    /**
     * Create a new CreditCardUnregister.
     *
     * @param CreditCardUnregisterCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreditCardUnregisterCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreditCardUnregister|array The created CreditCardUnregister as an assoc-array at the
