...
// Tangocard SDK AsyncOrder entity
...
class AsyncOrderEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AsyncOrderEntity($this->_client, $opts);
    }

    /**
     * @param AsyncOrder|array $args AsyncOrder data (assoc-array) to store.
     */
    ...
    /**
     * @return AsyncOrder|array The current AsyncOrder data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AsyncOrder fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AsyncOrder fields).
     */
    ...
    /**
     * List AsyncOrder items matching the given filter.
     *
     * @param AsyncOrderListMatch|array|null $reqmatch Match filter (any subset
     *   of AsyncOrder fields) as an assoc-array; AsyncOrderListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AsyncOrder[]|array A list of AsyncOrder items as assoc-arrays at
    ...
    /**
     * Create a new AsyncOrder.
     *
     * @param AsyncOrderCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AsyncOrderCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AsyncOrder|array The created AsyncOrder as an assoc-array at the
