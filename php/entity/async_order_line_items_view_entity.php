...
class AsyncOrderLineItemsViewEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "async_order_line_items_view";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AsyncOrderLineItemsViewEntity($this->_client, $opts);
    }

    /**
     * @param AsyncOrderLineItemsView|array $args AsyncOrderLineItemsView data (assoc-array) to store.
     */
    ...
    /**
     * @return AsyncOrderLineItemsView|array The current AsyncOrderLineItemsView data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AsyncOrderLineItemsView fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AsyncOrderLineItemsView fields).
     */
    ...
    /**
     * List AsyncOrderLineItemsView items matching the given filter.
     *
     * @param AsyncOrderLineItemsViewListMatch|array|null $reqmatch Match filter (any subset
     *   of AsyncOrderLineItemsView fields) as an assoc-array; AsyncOrderLineItemsViewListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AsyncOrderLineItemsView[]|array A list of AsyncOrderLineItemsView items as assoc-arrays at
