...
// Tangocard SDK EmailTemplateViewVerbose entity
...
class EmailTemplateViewVerboseEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "email_template_view_verbose";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmailTemplateViewVerboseEntity($this->_client, $opts);
    }

    /**
     * @param EmailTemplateViewVerbose|array $args EmailTemplateViewVerbose data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = TangocardHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return EmailTemplateViewVerbose|array The current EmailTemplateViewVerbose data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailTemplateViewVerbose fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = TangocardHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of EmailTemplateViewVerbose fields).
     */
    ...
    /**
     * Load a single EmailTemplateViewVerbose.
     *
     * @param EmailTemplateViewVerboseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmailTemplateViewVerboseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailTemplateViewVerbose|array The loaded EmailTemplateViewVerbose as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = TangocardHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * List EmailTemplateViewVerbose items matching the given filter.
     *
     * @param EmailTemplateViewVerboseListMatch|array|null $reqmatch Match filter (any subset
     *   of EmailTemplateViewVerbose fields) as an assoc-array; EmailTemplateViewVerboseListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailTemplateViewVerbose[]|array A list of EmailTemplateViewVerbose items as assoc-arrays at
     *   the SDK boundary; throws TangocardError on failure (item-5 convention).
     */
    ...
    /**
     * Create a new EmailTemplateViewVerbose.
     *
     * @param EmailTemplateViewVerboseCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmailTemplateViewVerboseCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailTemplateViewVerbose|array The created EmailTemplateViewVerbose as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing EmailTemplateViewVerbose.
     *
     * @param EmailTemplateViewVerboseUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmailTemplateViewVerboseUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailTemplateViewVerbose|array The updated EmailTemplateViewVerbose as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
