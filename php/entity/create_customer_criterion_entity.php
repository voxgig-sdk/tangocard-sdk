...
class CreateCustomerCriterionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "create_customer_criterion";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CreateCustomerCriterionEntity($this->_client, $opts);
    }

    /**
     * @param CreateCustomerCriterion|array $args CreateCustomerCriterion data (assoc-array) to store.
     */
    ...
    /**
     * @return CreateCustomerCriterion|array The current CreateCustomerCriterion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreateCustomerCriterion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreateCustomerCriterion fields).
     */
