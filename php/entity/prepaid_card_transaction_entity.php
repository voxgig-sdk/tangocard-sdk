...
// Tangocard SDK PrepaidCardTransaction entity
...
class PrepaidCardTransactionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "prepaid_card_transaction";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PrepaidCardTransactionEntity($this->_client, $opts);
    }

    /**
     * @param PrepaidCardTransaction|array $args PrepaidCardTransaction data (assoc-array) to store.
     */
    ...
    /**
     * @return PrepaidCardTransaction|array The current PrepaidCardTransaction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PrepaidCardTransaction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PrepaidCardTransaction fields).
     */
    ...
    /**
     * Load a single PrepaidCardTransaction.
     *
     * @param PrepaidCardTransactionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PrepaidCardTransactionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrepaidCardTransaction|array The loaded PrepaidCardTransaction as an assoc-array at the
