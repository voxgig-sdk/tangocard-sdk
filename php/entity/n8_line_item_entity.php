...
// Tangocard SDK N8LineItem entity
...
class N8LineItemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new N8LineItemEntity($this->_client, $opts);
    }

    /**
     * @param N8LineItem|array $args N8LineItem data (assoc-array) to store.
     */
    ...
    /**
     * @return N8LineItem|array The current N8LineItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of N8LineItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of N8LineItem fields).
     */
    ...
    /**
     * Update an existing N8LineItem.
     *
     * @param N8LineItemUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed N8LineItemUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return N8LineItem|array The updated N8LineItem as an assoc-array at the
