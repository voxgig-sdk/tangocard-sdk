...
// Tangocard SDK CreditCard entity
...
class CreditCardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CreditCardEntity($this->_client, $opts);
    }

    /**
     * @param CreditCard|array $args CreditCard data (assoc-array) to store.
     */
    ...
    /**
     * @return CreditCard|array The current CreditCard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreditCard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreditCard fields).
     */
    ...
    /**
     * Load a single CreditCard.
     *
     * @param CreditCardLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CreditCardLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreditCard|array The loaded CreditCard as an assoc-array at the
     ...
     *
     * @param CreditCardCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreditCardCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreditCard|array The created CreditCard as an assoc-array at the
     *   SDK boundary; throws TangocardError on failure (item-5 convention).
     */
