...
class ResendEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ResendEntity($this->_client, $opts);
    }

    /**
     * @param Resend|array $args Resend data (assoc-array) to store.
     */
    ...
    /**
     * @return Resend|array The current Resend data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Resend fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Resend fields).
     */
     ...
     * Create a new Resend.
     *
     * @param ResendCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ResendCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Resend|array The created Resend as an assoc-array at the
