...
class N3FundEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new N3FundEntity($this->_client, $opts);
    }

    /**
     * @param N3Fund|array $args N3Fund data (assoc-array) to store.
     */
    ...
    /**
     * @return N3Fund|array The current N3Fund data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of N3Fund fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of N3Fund fields).
     */
