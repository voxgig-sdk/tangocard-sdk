...
class N2AccountEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new N2AccountEntity($this->_client, $opts);
    }

    /**
     * @param N2Account|array $args N2Account data (assoc-array) to store.
     */
    ...
    /**
     * @return N2Account|array The current N2Account data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of N2Account fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of N2Account fields).
     */
