...
// Tangocard SDK TransferFund entity
...
class TransferFundEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TransferFundEntity($this->_client, $opts);
    }

    /**
     * @param TransferFund|array $args TransferFund data (assoc-array) to store.
     */
    ...
    /**
     * @return TransferFund|array The current TransferFund data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TransferFund fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TransferFund fields).
     */
    ...
    /**
     * Create a new TransferFund.
     *
     * @param TransferFundCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TransferFundCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TransferFund|array The created TransferFund as an assoc-array at the
