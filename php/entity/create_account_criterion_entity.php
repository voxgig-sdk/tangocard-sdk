...
class CreateAccountCriterionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "create_account_criterion";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CreateAccountCriterionEntity($this->_client, $opts);
    }

    /**
     * @param CreateAccountCriterion|array $args CreateAccountCriterion data (assoc-array) to store.
     */
    ...
    /**
     * @return CreateAccountCriterion|array The current CreateAccountCriterion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CreateAccountCriterion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CreateAccountCriterion fields).
     */
    ...
    /**
     * Create a new CreateAccountCriterion.
     *
     * @param CreateAccountCriterionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CreateAccountCriterionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CreateAccountCriterion|array The created CreateAccountCriterion as an assoc-array at the
