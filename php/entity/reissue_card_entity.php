...
// Tangocard SDK ReissueCard entity
...
class ReissueCardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReissueCardEntity($this->_client, $opts);
    }

    /**
     * @param ReissueCard|array $args ReissueCard data (assoc-array) to store.
     */
    ...
    /**
     * @return ReissueCard|array The current ReissueCard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReissueCard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReissueCard fields).
     */
    ...
    /**
     * Create a new ReissueCard.
     *
     * @param ReissueCardCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReissueCardCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReissueCard|array The created ReissueCard as an assoc-array at the
