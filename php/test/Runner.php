...
class TangocardTestRunner
{
    ...
    {
        $live = self::getenv('TANGOCARD_TEST_LIVE');
        $override = self::getenv('TANGOCARD_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TANGOCARD_TEST_EXPLAIN');
...
class_alias('TangocardTestRunner', 'Runner');
class_alias('TangocardHelpers', 'Helpers');
