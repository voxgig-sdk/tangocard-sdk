...
class AccountEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TANGOCARD_TEST_ACCOUNT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $account_ref01_markdef_up0_name = "accountIdentifier";
...
function account_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["account01", "account02", "account03", "customer01", "customer02", "customer03", "customerentifier01"] as $k) {
    ...
    $entid_env_raw = getenv("TANGOCARD_TEST_ACCOUNT_ENTID");
