...
// Tangocard SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TangocardSDK::test)
...
{
    private const SDK_CLASS = 'TangocardSDK';
    ...
    private const SDK_BASE = 'tangocard_sdk';
