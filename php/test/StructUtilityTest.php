...
// Tangocard SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TangocardOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TangocardOmni::structfix($now, Struct::undef()))
                        !== json_encode(TangocardOmni::structfix($val, Struct::undef()))) {
