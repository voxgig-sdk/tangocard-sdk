...
// Tangocard SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class TangocardTransformResponse
{
    public static function call(TangocardContext $ctx): mixed
    {
        ...
        $transform = TangocardHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
