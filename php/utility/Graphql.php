...
class TangocardGraphql
{
    ...
    // equivalent.
    public static function body(TangocardContext $ctx): mixed
    {
    ...
    public static function errors(TangocardContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
