...
// Tangocard SDK utility: fetcher

class TangocardFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TangocardSDK/1.0)';
    ...
    public static function call(TangocardContext $ctx, string $fullurl, array $fetchdef): array
    {
