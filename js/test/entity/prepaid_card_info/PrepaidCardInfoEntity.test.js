...
describe('PrepaidCardInfoEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    const prepaid_card_info_ref01_match_dt0 = {}
    const prepaid_card_info_ref01_data_dt0 = (await prepaid_card_info_ref01_ent.load(prepaid_card_info_ref01_match_dt0)).data()
    assert(null != prepaid_card_info_ref01_data_dt0)
